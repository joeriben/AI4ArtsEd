    ...
    crossmodal: {
      ...
      synth: {
        ...
        sequencer: {
          ...
          patterns: {
            arpeggio_up: 'Арпеджіо вгору',
            arpeggio_down: 'Арпеджіо вниз',
            arpeggio_updown: 'Арпеджіо вгору-вниз',
            octaves: 'Октави',
            power_chord: 'Пауер-акорд',
            minor_pentatonic: 'Мінорна пентатоніка',
            bass_groove: 'Бас-грув',
            trance_gate: 'Транс-гейт',
          },
        },
