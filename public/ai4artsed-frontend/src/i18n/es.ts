export const es = {
  ...
  generationError: {
    busy: '¡La IA está muy ocupada en este momento. Inténtalo de nuevo en un momento!',
    offline: 'La IA no está disponible en este momento.',
  ...
  mediaOutput: {
    download: 'Descargar',
    model3dReady: 'Modelo 3D generado',
    model3dInteractive: 'Gira y acerca el modelo 3D con el tacto o el ratón',
    downloadGlb: 'Descargar modelo 3D (GLB)',
    print: 'Imprimir',
    analyze: 'Análisis de imagen',
    analyzing: 'Analizando...',
    generatedImage: 'Imagen generada',
    mediaCreated: 'Archivo multimedia creado',
    analysisTitle: 'Análisis de imagen',
    close: 'Cerrar',
    saveSoon: 'Guardar (próximamente)',
    trashyReflection: 'Habla con Trashy sobre:',
    forwardToImageTransform: 'Enviar a transformación de imagen',
  },
  settings: {
    ...
    safety: {
      kidsTitle: 'Niños (8–13)',
      kidsDesc: 'Todos los filtros activos: §86a, RGPD, protección de contenido estrictamente apropiada para niños (sin imágenes de terror, sin violencia representada, sin desnudos), verificación VLM de imágenes',
      youthTitle: 'Jóvenes (14–18)',
      youthDesc: 'Todos los filtros activos: §86a, RGPD, protección de contenido apropiada para la edad para adolescentes mayores (violencia gráfica, gore, desnudos, odio, autolesiones y terrorismo bloqueados; imágenes de terror no gráfico permitidas), verificación VLM de imágenes',
      adultTitle: 'Adultos',
    ...
    models: {
      ...
      localModelsAvailable: '{count} modelos locales disponibles (escribe o selecciona del menú)',
      stage1Text: 'Modelo de traducción',
      stage2Interception: 'Modelo de transformación',
      stage2Optimization: 'Modelo de optimización de prompts',
      stage3: 'Modelo de seguridad',
      stage4Legacy: 'Modelo legacy',
      chatHelper: 'Modelo de chat',
      persona: 'Modelo de persona',
      imageAnalysis: 'Modelo de análisis de imágenes',
      coding: 'Modelo de generación de código'
    },
    api: {
      ...
      mammouthEu: 'Mammouth AI (basado en la UE, DSGVO)',
      ...
      mammouthInfo: 'Mammouth AI (basado en la UE)',
      mammouthDsgvo: 'Conforme con DSGVO (infraestructura UE)',
    ...
    backendStatus: {
      loading: 'Verificando estado del backend...',
      refresh: 'Actualizar',
      refreshing: 'Actualizando...',
      localInfrastructure: 'Infraestructura local',
      cloudApis: 'APIs en la nube',
      outputConfigs: 'Configuraciones de salida por backend',
      reachable: 'Accesible',
      ...
      dsgvoNotCompliant: 'No conforme',
      configsAvailable: '{available} de {total} configuraciones disponibles',
      hidden: 'oculto',
      model: 'Modelo',
      loadedModels: 'Modelos cargados',
      foreignProcesses: 'Otros procesos GPU',
      noModelsLoaded: 'No hay modelos cargados actualmente',
      vramUsage: 'VRAM',
      inUse: 'En uso',
      idle: 'Inactivo',
      lastUsed: 'Último uso',
      command: 'Comando',
      foreignVram: 'Uso externo de VRAM',
      showLoadedModels: 'Mostrar modelos cargados',
      hideLoadedModels: 'Ocultar modelos cargados',
      showProcesses: 'Mostrar procesos',
      hideProcesses: 'Ocultar procesos',
      ownModels: 'Modelos propios',
      pid: 'PID',
      localLlm: 'LLM local',
    },
    apiManagement: {
      loading: 'Cargando datos de uso de API...',
      refresh: 'Actualizar',
      refreshing: 'Actualizando...',
      activeProvider: 'Proveedor en la nube activo',
      noProvider: 'No hay proveedor en la nube configurado (solo local)',
      accountOverview: 'Resumen de cuenta',
      currentSpend: 'Gasto actual',
      budgetLimit: 'Límite de presupuesto',
      remaining: 'Restante',
      unlimited: 'Ilimitado',
      resetDate: 'Restablecimiento del presupuesto',
      rateLimit: 'Límite de velocidad',
      billingError: 'No se pudieron obtener los datos de facturación',
      localUsage: 'Seguimiento de uso local',
      noUsageData: 'Aún no se han registrado datos de uso. Los datos aparecerán después de llamadas a la API en la nube.',
      calls: 'Llamadas',
      ...
      configured: 'Configurado',
      notConfigured: 'No configurado',
      modelAssignments: 'Asignaciones de modelos',
      function: 'Función',
    }
  },
  pipeline: {
  ...
  sketchCanvas: {
    drawHere: 'Dibuja tu boceto aquí',
    pen: 'Pluma',
    eraser: 'Borrador',
    undo: 'Deshacer',
    clear: 'Limpiar',
  ...
  mediaInput: {
    ...
    queueAhead: '{count} generación antes que tú | {count} generaciones antes que tú',
    deviceBusy: 'Ya hay una generación en curso en este dispositivo.',
    cancelPrevious: 'Cancelar la generación anterior',
  ...
  canvas: {
    ...
    outputDrawer: {
      title: 'Resultados',
      emptyState: 'Ejecuta el flujo de trabajo para generar resultados'
    },
    zoomControls: {
      zoomIn: 'Acercar',
      zoomOut: 'Alejar',
    ...
    stage: {
      ...
      randomPrompt: {
        tokenLimit: 'Longitud del prompt'
      },
      display: {
  ...
  about: {
    ...
    credits: {
      title: 'Créditos',
      emt140: 'Respuestas al impulso de reverberación de placa: EMT-140 por Greg Hopkins / Hopkins Media Services (CC-BY)'
    },
    funding: {
  ...
  multiImage: {
    ...
    defaultPrompt: 'Transforma estas imágenes en una descripción escénica',
  ...
  imageTransform: {
    ...
    configs: {
      ...
      wan22I2v: {
        name: 'WAN 2.2 Imagen a video (14B)'
      },
      hunyuan3d: {
        label: 'Hunyuan\n3D',
        name: 'Hunyuan3D-2 Imagen a 3D'
      },
      sd35Img2img: {
        name: 'SD 3.5 Large Imagen a imagen'
      }
    },
    yourImage: 'Tu imagen',
    printTitle: 'Imprimir: imagen transformada',
    downloadError: 'Error al descargar',
    analysisFailed: 'El análisis de imagen falló',
    analysisError: 'Error durante el análisis de imagen',
    defaultPrompt: 'Transforma esta imagen en una descripción escénica',
  },
  textTransform: {
    ...
    selectMedium: 'Elige un medio',
    selectModel: 'Selecciona un modelo',
    runCode: 'Ejecutar código',
    p5jsCode: 'Código P5.js',
    livePreview: 'Vista previa en vivo',
    tonejsCode: 'Código Tone.js',
    audioPlayer: 'Reproductor de audio',
    forwardToImage: 'Enviar a transformación de imagen',
    yourImage: 'Tu imagen',
    pleaseSelectModel: 'Por favor, selecciona un modelo',
    saveSoon: '¡Función de guardado próximamente!',
    categories: {
      image: 'Imagen',
      video: 'Video',
      sound: 'Sonido',
  ...
  surrealizer: {
    ...
    infoDescription: 'Dos "cerebros" de IA leen tu texto: CLIP-L entiende el lenguaje a través de imágenes (77 tokens, 768 dimensiones), T5-XXL lo entiende de forma puramente lingüística (512 tokens, 4096 dimensiones). El control deslizante no simplemente mezcla — empuja la imagen mucho más allá de lo que ambos encoders producirían solos. Cómo se distribuye la extrapolación a lo largo de la secuencia de tokens lo controla la Estrategia de fusión.',
    purposeTitle: 'Estrategia de fusión & Control deslizante',
    purposeText: 'La Estrategia de fusión determina DÓNDE ocurre la extrapolación. Dual Alpha distorsiona suavemente los primeros 77 tokens (el núcleo visual de CLIP-L) mientras extrapola completamente los tokens T5 extendidos — la imagen permanece estructuralmente reconocible pero se vuelve estéticamente sorprendente. Normalizado aplica la misma extrapolación en todos lados pero controla la magnitud para que ningún token domine la atención. Legacy solo extrapola los primeros 77 tokens y deja el resto sin cambios — el enfoque original, pero menos surrealista con prompts largos porque los tokens T5 sin modificar diluyen el efecto. ◆ El control deslizante α controla QUÉ TAN LEJOS: α = 0 es CLIP-L puro (normal), α = 1 es T5 puro (todavía normal), α > 1 empuja más allá de T5 hacia un espacio vectorial inexplorado. Punto óptimo: 15–35. ◆ α < 0 invierte T5 y amplifica CLIP-L — alucinaciones cualitativamente diferentes.',
    techTitle: 'Cómo funciona',
    techText: 'CLIP-L codifica en 768 dimensiones, rellenado a 4096 — 3328 dimensiones son ceros. T5-XXL llena las 4096 dimensiones. Esta asimetría es el motor: la extrapolación aprovecha el espacio CLIP-L disperso. La fórmula (1-α)·CLIP-L + α·T5 se aplica a las primeras 77 posiciones de tokens donde ambos encoders tienen datos. Más allá de la posición 77 solo existe T5. Cómo se tratan estos tokens extendidos es lo que distingue las tres estrategias: Dual Alpha los multiplica por α (extrapolación completa), Normalizado hace lo mismo pero reescala a la magnitud T5 típica, Legacy los deja en 1× (sin cambios). Con valores α altos, esta diferencia es dramática — un factor 25× entre Legacy y los otros dos.',
    ...
    fusionStrategyLabel: 'Estrategia de fusión',
    fusion_dual_alpha: 'Dual Alpha',
    fusion_normalized: 'Normalizado',
    fusion_legacy: 'Legacy',
    fusionHint_dual_alpha: 'α suave en tokens centrales (ancla estructural via CLIP-L), α completo en tokens extendidos (sorpresa estética). Estructuralmente reconocible, estéticamente sorprendente.',
    fusionHint_normalized: 'α uniforme en todos los tokens, luego normalizado L2 a la magnitud T5 típica. Misma dirección de extrapolación que Dual Alpha, pero magnitud controlada — ningún token domina la atención.',
    fusionHint_legacy: 'Comportamiento original: extrapola los primeros 77 tokens, añade el resto T5 sin cambios (1×). Menos surrealista con prompts largos — los tokens sin modificar diluyen el efecto.',
    ...
    seedLabel: 'Seed',
    seedHint: '-1 = aleatorio. Un seed fijo permite la comparación A/B entre estrategias.',
    executeButton: 'Ejecutar',
    executingButton: 'Generando...'
  },
  musicGeneration: {
  ...
  latentLab: {
    ...
    imageLab: {
      ...
      tabs: {
        ...
        composable: {
          ...
          short: 'Mezcla de múltiples conceptos'
        },
        arcimboldo: {
          label: 'Mosaico Arcimboldo',
          short: 'Fotomosaico desde atención'
        }
      }
    },
    ...
    shared: {
      ...
      randomVariation: 'Variación aleatoria',
    ...
    arcimboldo: {
      headerTitle: 'Mosaico Arcimboldo — Pintar con el vocabulario propio del modelo',
      headerSubtitle: 'Genera una imagen, deja que el modelo la segmente por significado y luego reemplaza cada región semántica con pequeñas piezas generadas por IA de ese concepto — un fotomosaico donde la mesa está construida de imágenes diminutas de mesas.',
      explanationToggle: 'Mostrar explicación detallada',
      explainWhatTitle: '¿Qué hace esta herramienta?',
      explainWhatText: 'Con el nombre de Giuseppe Arcimboldo, quien pintaba retratos compuestos de frutas, verduras y objetos, esta herramienta crea fotomosaicos a partir de imágenes generadas por IA. Primero, el modelo genera una imagen y revela qué palabra del prompt influye en qué región (mediante mapas de atención). Luego, cada región semántica se reemplaza por muchas pequeñas piezas generadas por IA de ese concepto. El resultado es un mosaico que desde lejos se lee como la imagen original, pero de cerca revela que cada región está construida con su propio concepto.',
      explainHowTitle: '¿Cómo funciona?',
      explainHowText: 'Paso 1: Genera una imagen con SD3.5 y extrae mapas de atención (igual que Cartografía de atención). Paso 2: La segmentación winner-takes-all asigna cada posición espacial a la palabra con mayor atención. Paso 3: Para cada región semántica, genera pequeñas piezas de ese concepto con ajuste de color al original. Paso 4: Ensambla las piezas en una cuadrícula de mosaico.',
      techTitle: 'Detalles técnicos',
      techText: 'Los mapas de atención se capturan a resolución espacial de 64×64 desde 3 capas del transformer (early/mid/late). La segmentación usa winner-takes-all con limpieza morfológica para fusionar regiones menores al 2% de la imagen. Las piezas se generan a 512×512 con pasos reducidos (8) para mayor velocidad, luego se transfiere color para coincidir con el color medio de cada región en espacio LAB. La asignación de cuadrícula usa voto mayoritario por celda.',
      step1Title: 'Paso 1 — Generar imagen + mapas de atención',
      step2Title: 'Paso 2 — Regiones semánticas',
      step3Title: 'Paso 3 — Generación de piezas',
      step4Title: 'Paso 4 — Resultado del mosaico',
      promptPlaceholder: 'p. ej. Un gato sentado en una mesa en un jardín',
      gridSizeLabel: 'Cuadrícula del mosaico',
      settingsToggle: 'Configuración avanzada',
      stepsLabel: 'Pasos',
      cfgLabel: 'CFG',
      seedLabel: 'Seed',
      generateBtn: 'Generar + Segmentar',
      generatingStatus: 'Generando imagen y extrayendo mapas de atención...',
      segmentingStatus: 'Segmentando regiones semánticas...',
      generateTilesBtn: 'Generar piezas para todas las regiones',
      tilesStatus: 'Generando piezas: {done} / {total}',
      originalLabel: 'Original',
      mosaicLabel: 'Mosaico',
      blendLabel: 'Mezcla',
      downloadBtn: 'Descargar mosaico',
      resetBtn: 'Empezar de nuevo',
    },
    composable: {
      headerTitle: 'Diffusion composable — Energía independiente para cada concepto',
      headerSubtitle: 'En lugar de codificar todo tu prompt como un vector monolítico, cada concepto recibe su propio paso por el transformer durante el denoising. Las predicciones de ruido se mezclan con pesos que tú controlas.',
      explanationToggle: 'Mostrar explicación detallada',
      explainWhatTitle: '¿Qué hace esta herramienta?',
      explainWhatText: 'La generación estándar de imágenes comprime todo tu prompt en una única representación. El modelo ve "una casa roja junto a un lago" como un concepto fusionado. La Diffusion composable lo separa: "casa roja" y "lago" reciben cada uno su propio procesamiento completo a través de la red neuronal en cada paso de denoising. Sus predicciones de ruido se combinan con pesos ajustables. Esto da a cada concepto su propia "función de energía" — su propio voto sobre cómo debería ser la imagen.',
      explainHowTitle: '¿Cómo funciona técnicamente?',
      explainHowText: 'En cada uno de los 25 pasos de denoising, el modelo ejecuta N+1 pasadas por el transformer: una para el prompt negativo (incondicional) y una por cada concepto. Cada concepto produce su propia predicción de ruido. Estas se mezclan con tus ajustes de peso: ruido_compuesto = w1×ruido_1 + w2×ruido_2 + ... El ruido compuesto se usa luego con classifier-free guidance (CFG) y el paso del programador. El resultado es una imagen donde cada concepto contribuye de forma independiente.',
      techTitle: 'Detalles técnicos',
      techText: 'Basado en Liu et al. (2022). Cada concepto se codifica con los tres codificadores de SD3.5 (CLIP-L, OpenCLIP-G, T5-XXL) de forma independiente. El bucle de denoising personalizado llama a pipe.transformer() una vez por concepto por paso, produciendo predicciones de ruido por concepto que se ponderan y suman. VRAM: los pesos del modelo se comparten entre pasadas; solo varían las activaciones. Con 4 conceptos, la generación tarda aproximadamente 4 veces más que la estándar (cada paso necesita 5 pasadas por el transformer en lugar de 2).',
      referencesTitle: 'Referencias de investigación',
      conceptLabel: 'Concepto {n}',
      conceptPlaceholder: 'p. ej. una casa roja en una colina',
      weightLabel: 'Peso',
      removeBtn: 'Eliminar',
      addConceptBtn: 'Agregar concepto',
      settingsToggle: 'Configuración avanzada',
      negativePromptLabel: 'Prompt negativo',
      negativePromptPlaceholder: 'p. ej. borroso, texto, marca de agua',
      stepsLabel: 'Pasos',
      cfgLabel: 'CFG',
      seedLabel: 'Seed',
      normalizeLabel: 'Normalizar pesos (suma = 1.0)',
      generateBtn: 'Generar',
      generating: 'Generación composable en curso...',
      resultInfo: '{concepts} conceptos | {time} | seed {seed}',
    ...
    textLab: {
      ...
      bias: {
        ...
        referencesTitle: 'Referencias de investigación',
        scenarioQwen: 'Familia Qwen',
        scenarioMixed: 'Familias mixtas',
        scenarioQwenHint: 'Misma familia de modelos, diferentes tamaños — aísla cómo el tamaño afecta los sesgos.',
        scenarioMixedHint: 'Diferentes familias de modelos, tamaños similares — aísla cómo el tokenizador y los datos de entrenamiento afectan los sesgos.',
    ...
    crossmodal: {
      ...
      synth: {
        ...
        extractionRegion: 'Región de extracción',
        ...
        wavetableExtract: 'Desde muestra',
        wtReextract: 'Reextraer',
        wavetableSemantic: 'Desde eje',
        wtSelectAxis: '— seleccionar eje —',
        wtBuild: 'Construir',
        wtBuilding: 'Construyendo...',
        wtBuildHint: 'Genera muestras cortas a lo largo del eje para crear una wavetable semánticamente ordenada',
        wtRange: 'Rango',
        wtInterpolate: 'Interpolar',
        wtScanEnvelope: 'Escanear',
        wtSweep: 'Barrido',
        wtReturn: 'Retorno',
        ...
        startPositionHint: '0% = ataque/inicio, mayor = material sostenido/estacionario',
        ...
        dimensions: {
          ...
          hintRelative: 'Arrastra arriba = hacia el Prompt A, abajo = hacia el Prompt B. Cada barra mezcla entre los dos prompts por dimensión.',
        ...
        filter: {
          ...
          mix: 'Mezcla',
          kbdTrack: 'Seguimiento de teclado',
          envelope: 'Envolvente del filtro',
          envAmount: 'Cantidad',
          lfoRate: 'Velocidad LFO',
          lfoDepth: 'Profundidad LFO',
          amplitude: 'Amplitud',
        },
        preset: {
        ...
        semanticAxes: {
          ...
          slotNone: '— ninguno —',
          groupSemantic: 'Semántico (polos textuales)',
          groupPCA: 'PCA (basado en datos)',
  ...
  compare: {
    activation: {
      button: 'Activar Trashy',
      language: 'El mismo prompt, diferentes idiomas, diferentes imágenes. Este modo muestra cómo el idioma codifica valores culturales predeterminados que dan forma a lo que genera la IA.',
      model: 'El mismo prompt, diferentes modelos, diferentes suposiciones. Revela qué trata cada modelo como el humano, la familia o la profesión predeterminada.',
      'vlm-analysis': 'Sube una imagen y deja que varios modelos de visión la describan. Revela lo que cada modelo percibe, lo que ignora y dónde divergen las descripciones.',
      systemprompt: 'El mismo mensaje con tres prompts de sistema diferentes. Muestra cómo instrucciones invisibles convierten a la misma IA en personalidades diferentes.',
      'llm-model': 'La misma pregunta a tres modelos de IA distintos. Muestra dónde los datos de entrenamiento, las políticas de seguridad y las suposiciones culturales producen respuestas diferentes.',
      temperature: 'El mismo mensaje en tres niveles de aleatoriedad: determinístico, equilibrado, creativo. Muestra cómo el muestreo de probabilidad cambia la salida de la IA.',
    },
    tabs: {
      model: 'Sesgo del modelo',
      language: 'Sesgo cultural',
      'llm-model': 'Sesgo de modelo',
      'vlm-analysis': 'Comprensión de imagen',
      systemprompt: 'Prompts de sistema',
      temperature: 'Caliente y frío',
    },
    shared: {
      ...
      modelLabel: 'Modelo',
      defaultModel: 'Predeterminado (ajustes)',
      modelNotDownloaded: '(no descargado)',
    },
    temperature: {
      inputLabel: 'Tu mensaje',
      inputPlaceholder: 'Escribe un mensaje para enviar a las tres temperaturas...',
      cold: 'Determinístico',
      warm: 'Equilibrado',
      hot: 'Creativo',
      subtitle: 'Observa cómo la aleatoriedad cambia lo que dice la IA',
    },
    systemprompt: {
      inputLabel: 'Tu mensaje',
      inputPlaceholder: 'Escribe un mensaje para enviar con los tres prompts de sistema...',
      subtitle: 'Observa cómo las instrucciones invisibles controlan el comportamiento de la IA',
      presetLabel: 'Preset',
      promptLabel: 'Prompt de sistema',
      emptyPrompt: '(sin prompt de sistema)',
      custom: 'Personalizado',
      presets: {
        none: 'Sin prompt de sistema',
        claude: 'Claude Sonnet 4.6 (2025)',
        gpt4_2023: 'GPT-4 (2023)',
        helpful: 'Asistente útil',
        disagree: 'Siempre en desacuerdo',
        pirate: 'Pirata',
        poet: 'Poeta',
        fiveyearold: 'Niño de cinco años',
        factsonly: 'Solo hechos',
      },
    },
    llmModel: {
      inputLabel: 'Tu mensaje',
      inputPlaceholder: 'Escribe un mensaje para enviar a los tres modelos...',
      systemPromptLabel: 'PROMPT DE SISTEMA',
    },
    vlmAnalysis: {
      imageLabel: 'Tu imagen',
      perspectiveLabel: 'Perspectiva',
      modelsLabel: 'Modelos de visión',
      noModelsInstalled: 'No hay modelos de visión instalados localmente.',
      analyzeBtn: 'Analizar imagen',
      analyzing: 'Analizando...',
      waiting: 'esperando',
      freePromptPlaceholder: 'Escribe tu propio prompt de análisis...',
      perspectives: {
        free: 'Libre (tu propio prompt)',
        neutral: 'Descripción neutral',
        safety: 'Verificación de seguridad',
        bildwissenschaftlich: 'Histórico-artístico (Panofsky)',
        ikonik: 'Análisis icónico (Imdahl)',
        bildungstheoretisch: 'Teoría educativa (Joerissen/Marotzki)',
        ethisch: 'Análisis ético',
        kritisch: 'Decolonial / Crítico',
      },
    },
    promptLabel: 'Tu idea',
    promptPlaceholder: 'Ingresa un prompt — p. ej. "Un hermoso jardín con flores"',
    platformLanguages: 'Idiomas de la plataforma',
    furtherLanguages: 'Más idiomas',
    selectHint: '{count} de {max} idiomas seleccionados',
    modelLabel: 'Modelo',
    generateAll: 'Comparar todos',
    generatingAll: 'Generando...',
    generating: 'Generando...',
    waiting: 'Esperando...',
    chatPlaceholder: 'Pregunta a Trashy...',
    trashyGreeting: '¡Hola! Puedo ayudarte a explorar cómo diferentes idiomas producen imágenes distintas. Ingresa un prompt y elige al menos 2 idiomas — te explicaré qué sucede.',
    trashyTranslating: 'Traduciendo tu prompt a los idiomas seleccionados...',
    trashyGenerating: 'Ahora generando imágenes — mismo seed, mismo modelo, solo cambia el idioma. ¡Observa lo que ocurre!',
    trashyTranslateError: 'El servicio de traducción no está disponible en este momento. Es posible que el servidor backend necesite reiniciarse.',
    trashyError: 'Algo salió mal. Revisa la consola del navegador para más detalles o pregunta al instructor del curso.',
    favorite: 'Agregar a favoritos',
    unfavorite: 'Eliminar de favoritos',
    forward: 'Enviar a transformación de imagen',
    download: 'Descargar imagen',
    analyze: 'Analizar imagen',
  },
  provenance: {
    title: 'Acerca de este modelo',
    madeBy: 'Creado por:',
    learnedFrom: 'Aprendió de:',
    howBig: 'Qué tan grande:',
    kidsNote: 'No a todos los creadores se les preguntó si la IA podía aprender de su trabajo.',
    publisher: 'Editor',
    ...
    consent: 'Consentimiento del creador',
    consentValues: {
      none: 'Ninguno',
      partial: 'Parcial',
      full: 'Completo',
    ...
    knownBiases: 'Sesgos conocidos',
    knownGaps: 'Lagunas conocidas',
    youthReflection: 'Cada modelo tiene una perspectiva moldeada por sus datos de entrenamiento. ¿Qué voces podrían estar ausentes?',
  },
  persona: {
    title: 'Persona',
    inputPlaceholder: 'Di algo...',
    toggleTTS: 'Activar/desactivar salida de voz',
    fallbackGreeting: 'Hola, soy Persona. Soy una máquina. No un asistente. Háblame.',
    newDialog: 'Nuevo diálogo',
    description: 'Persona es una IA con la que puedes hablar. Decide si generar imágenes, sonido, video u objetos 3D durante la conversación. Tiene opiniones y puede negarse.',
    activate: 'Iniciar conversación',
  },
  workshop: {
    title: 'Planificación del taller',
    memory: {
      label: 'Memoria de la tarjeta gráfica (VRAM)',
      system: 'Sistema',
      free: 'libre',
      used: '{used} / {total} gigabytes en uso',
      overBudget: '— ¡no cabe!',
    },
    models: {
      label: 'Modelos — arrastra a la memoria o haz clic para activar',
      image: 'Imágenes',
      video: 'Videos',
      music: 'Música',
      sound: 'Sonidos',
      threeD: '3D',
      needsGb: 'necesita {gb} gigabytes',
      loaded: '(cargado)',
      cloudUs: 'Basado en servidor — no se carga en VRAM',
      cloudEu: 'Basado en servidor — no se carga en VRAM',
    },
    confirm: {
      load: 'Cargar modelos en memoria ahora',
      loading: 'Cargando modelos...',
      ready: '¡Todo cargado — listo!',
      resultLoaded: 'Cargado: {models}',
      resultSkipped: 'En primer uso: {models}',
      resultError: 'Error: {details}',
    },
    actions: {
      clearAll: 'Limpiar toda la memoria GPU',
      confirmUnload: '¿Descargar {name}? Esto interrumpirá cualquier generación en curso que use este modelo.',
      confirmUnloadComfyui: 'Descargar {name} liberará TODOS los modelos de ComfyUI de la memoria (ComfyUI no admite descarga por modelo). ¿Continuar?',
      confirmClearAll: 'Esto interrumpirá todos los procesos en ejecución y descargará TODOS los modelos de la memoria. ¿Continuar?',
    },
    chat: {
      cloudAdded: '{name} se ejecuta en servidores de {publisher} en {region}. No necesita espacio en la tarjeta gráfica, pero tus entradas se envían allí. Cada resultado cuesta dinero del presupuesto del proyecto.',
      overBudget: '{name} necesita {gb} gigabytes. ¡No cabe en la memoria! Necesitas eliminar otro modelo o no usar {name}.',
      freeSpace: '{name} necesita {gb} gigabytes. Quedan {free} gigabytes libres.',
      connectionError: 'Error de conexión — por favor, inténtalo de nuevo.',
      regionEu: 'Europa',
      regionUs: 'Estados Unidos',
      preloadStart: 'Cargando {count} modelo(s) en memoria. Esto puede tardar unos minutos — cada modelo necesita entre 30 segundos y 2 minutos.',
      preloadModel: 'Cargando {name}...',
      preloadDone: '{name} cargado.',
      unloading: 'Descargando {name}...',
      unloaded: '{name} descargado.',
      clearingAll: 'Limpiando toda la memoria GPU...',
      clearedAll: 'Todos los modelos descargados. La memoria GPU está libre.',
    },
    greeting: {
      intro: 'Hola a todos. Soy Trashy, el sistema de ayuda de esta plataforma.',
      context: 'Estás en la página de planificación del taller. Tiene sentido, porque antes de empezar vale la pena pensar brevemente qué quieres hacer realmente.',
      resources: 'Los modelos de IA requieren sorprendentemente muchos recursos. Sobre todo, necesitan memoria en la tarjeta gráfica — la unidad de procesamiento que calcula tus imágenes, videos y sonidos. Esta memoria es grande, pero no infinita. Y los modelos que quieres usar son tan extensos que se llena rápidamente.',
      planning: 'Cuando alguien activa un nuevo modelo mientras la memoria ya está llena, pueden producirse largas esperas. Solo cargar un modelo tarda entre 30 segundos y 2 minutos. Una vez cargado, todo suele ir muy rápido.',
      flexibility: 'Por supuesto puedes cargar o cambiar a otros modelos en cualquier momento sin volver a esta página. Pero entonces esperas. Y un buen trabajo, ya sea artístico o experimental, suele comenzar pensando de antemano con qué quieres trabajar y por qué. Al fin y al cabo, si trabajas artísticamente, no coges simplemente el siguiente objeto de la calle porque resulta estar ahí.',
      callToAction: 'Mira las tarjetas de modelos en esta página. Puedes arrastrarlas a la barra de memoria y ver qué cabe junto. O cuéntame qué quieres hacer en la sesión y te explicaré qué modelos son adecuados.',
    },
    activate: 'Preguntar a Trashy',
  },
  trashy: {
    placeholder: '¿En qué puedo ayudarte?',
    greeting: '¡Hola! Soy tu asistente de IA. Hazme preguntas sobre AI4ArtsEd o déjame asesorarte sobre tu prompt.',
    noResponse: 'No se recibió respuesta.',
    thinking: 'Un momento...',
    sendError: 'Lo siento, hubo un error al enviar el mensaje. Por favor, inténtalo de nuevo.',
    sendTooltip: 'Enviar mensaje (Intro)',
    openTooltip: 'Abrir asistente IA (Trashy) — arrastra para mover, doble clic para restablecer',
    closeTooltip: 'Cerrar',
    analysisReflectionLoading: 'Analizando el análisis...',
    analysisReflectionError: 'No pude generar una reflexión en este momento. Puedes seguir leyendo el análisis de arriba.',
  },
  usageAgreement: {
    title: 'Acuerdo de uso',
    text: 'Esta plataforma usa IA para generar imágenes, sonidos y textos para la educación cultural. Se han incorporado amplias medidas de seguridad — pero ningún sistema técnico puede prevenir completamente resultados inesperados. Por ello, el uso está sujeto a las siguientes condiciones:',
    responsibilities: {
      title: 'Responsabilidades del responsable del taller',
      supervision: 'Supervisar activamente a los participantes durante toda la sesión.',
      ageAppropriate: 'Ajustar el nivel de seguridad según el grupo de edad.',
      misuse: 'Prevenir el mal uso y la elusión deliberada de los mecanismos de seguridad por parte de los participantes.',
      context: 'Probar la plataforma por tu cuenta antes de usarla con grupos.',
      noGuarantee: 'Ningún sistema técnico puede sustituir la supervisión pedagógica.',
    },
    checkbox: 'Acepto estas condiciones y asumo la responsabilidad como responsable del taller por el uso supervisado de esta plataforma.',
  ...
  edutainment: {
    ...
    denoising: {
      ...
      modelLoadingVram: 'Cargando modelo... {used} / {expected} GB VRAM',
      cloudProcessing: 'Enviando solicitud a la API en la nube...',
      encodingClipL: 'CLIP-L lee tu texto... ({count} tokens)',
      encodingClipG: 'CLIP-G lee tu texto... ({count} tokens)',
      encodingT5: 'T5-XXL lee tu texto... ({count} tokens)',
      encodingEmbeddings: 'Creando embeddings...',
      encodingDenoisingStarts: 'Comienza el denoising...',
    },
    energy: {
