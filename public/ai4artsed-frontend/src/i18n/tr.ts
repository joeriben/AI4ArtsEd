export const tr = {
  ...
  generationError: {
    busy: 'Yapay zeka şu an çok meşgul. Bir süre sonra tekrar deneyin!',
    offline: 'Yapay zeka şu an kullanılamıyor.',
  ...
  mediaOutput: {
    download: 'İndir',
    model3dReady: '3D model oluşturuldu',
    model3dInteractive: '3D modeli dokunma veya fare ile döndürün ve yakınlaştırın',
    downloadGlb: '3D Modeli İndir (GLB)',
    print: 'Yazdır',
    analyze: 'Görsel Analiz',
    analyzing: 'Analiz ediliyor...',
    generatedImage: 'Oluşturulan görsel',
    mediaCreated: 'Medya dosyası oluşturuldu',
    analysisTitle: 'Görsel Analiz',
    close: 'Kapat',
    saveSoon: 'Kaydet (Yakında)',
    trashyReflection: 'Trashy ile konuş:',
    forwardToImageTransform: 'Görsel Dönüşümüne İlet',
  },
  settings: {
    ...
    general: {
      ...
      bulgarianBg: 'Bulgarca (bg)'
    },
    safety: {
      kidsTitle: 'Çocuklar (8–13)',
      kidsDesc: 'Tüm filtreler aktif: §86a, KVKK, yaşa uygun içerik koruması (korku görseli, şiddet tasvirі ve çıplaklık yok), VLM görsel kontrolü',
      youthTitle: 'Gençler (14–18)',
      youthDesc: 'Tüm filtreler aktif: §86a, KVKK, büyük ergenler için yaşa uygun içerik koruması (ağır şiddet, kan ve gore, çıplaklık, nefret söylemi, öz-zarar ve terorizm engellenir; ghost, iskelet figürü, zombi gibi gore içermeyen korku görselleri izinlidir), VLM görsel kontrolü',
    ...
    models: {
      ...
      localModelsAvailable: '{count} yerel model mevcut (yazın veya açılır menüden seçin)',
      stage1Text: 'Çeviri Modeli',
      stage2Interception: 'Dönüşüm Modeli',
      stage2Optimization: 'Prompt Optimizasyon Modeli',
      stage3: 'Güvenlik Modeli',
      stage4Legacy: 'Eski Model',
      chatHelper: 'Sohbet Modeli',
      persona: 'Persona Modeli',
      imageAnalysis: 'Görsel Analiz Modeli',
      coding: 'Kod Üretimi Modeli'
    },
    api: {
      ...
      mammouthEu: 'Mammouth AI (AB merkezli, KVKK)',
      ...
      mammouthInfo: 'Mammouth AI (AB merkezli)',
      mammouthDsgvo: 'KVKK uyumlu (AB altyapısı)',
    ...
    backendStatus: {
      ...
      hidden: 'gizli',
      model: 'Model',
      loadedModels: 'Yüklü Modeller',
      foreignProcesses: 'Diğer GPU Süreçleri',
      noModelsLoaded: 'Şu an yüklü model yok',
      vramUsage: 'VRAM',
      inUse: 'Kullanımda',
      idle: 'Boşta',
      lastUsed: 'Son Kullanım',
      command: 'Komut',
      foreignVram: 'Harici VRAM kullanımı',
      showLoadedModels: 'Yüklü modelleri göster',
      hideLoadedModels: 'Yüklü modelleri gizle',
      showProcesses: 'Süreçleri göster',
      hideProcesses: 'Süreçleri gizle',
      ownModels: 'Kendi Modeller',
      pid: 'PID',
    },
    apiManagement: {
      loading: 'API kullanım verileri yükleniyor...',
      refresh: 'Yenile',
      refreshing: 'Yenileniyor...',
      activeProvider: 'Aktif Bulut Sağlayıcısı',
      noProvider: 'Bulut sağlayıcısı yapılandırılmamış (yalnızca yerel)',
      accountOverview: 'Hesap Genel Bakışı',
      currentSpend: 'Mevcut Harcama',
      budgetLimit: 'Bütçe Limiti',
      remaining: 'Kalan',
      unlimited: 'Sınırsız',
      resetDate: 'Bütçe Sıfırlama',
      rateLimit: 'Hız Limiti',
      billingError: 'Faturalama verileri alınamadı',
      localUsage: 'Yerel Kullanım Takibi',
      noUsageData: 'Henüz kullanım verisi kaydedilmedi. Bulut API çağrılarından sonra veriler görünecek.',
      calls: 'Çağrılar',
      inputTokens: 'Giriş Tokenleri',
      outputTokens: 'Çıkış Tokenleri',
      estCost: 'Tahmini Maliyet',
      byModel: 'Modele Göre',
      byStage: 'Aşamaya Göre',
      stage: 'Aşama',
      model: 'Model',
      from: 'Başlangıç',
      to: 'Bitiş',
      ...
      configured: 'Yapılandırıldı',
      notConfigured: 'Yapılandırılmadı',
      modelAssignments: 'Model Atamaları',
      function: 'İşlev',
    }
  },
  pipeline: {
  ...
  mediaInput: {
    ...
    queueAhead: 'Önünüzde {count} üretim var | Önünüzde {count} üretim var',
    deviceBusy: 'Bu cihazda halihazırda bir üretim çalışıyor.',
    cancelPrevious: 'Önceki üretimi iptal et',
  ...
  canvas: {
    ...
    outputDrawer: {
      title: 'Çıktılar',
      emptyState: 'Çıktı oluşturmak için iş akışını çalıştırın'
    },
    zoomControls: {
      zoomIn: 'Yakınlaştır',
      zoomOut: 'Uzaklaştır',
  ...
  about: {
    ...
    credits: {
      title: 'Teşekkürler',
      emt140: 'Plaka reverb impulse response\'ları: Greg Hopkins / Hopkins Media Services tarafından EMT-140 (CC-BY)'
    },
    funding: {
      title: 'Destekleyen'
    }
  ...
  usageAgreement: {
    ...
    text: 'Bu platform, kültürel eğitim için görsel, ses ve metin oluşturmak amacıyla yapay zeka kullanmaktadır. Kapsamlı güvenlik önlemleri entegre edilmiştir — ancak hiçbir teknik sistem beklenmedik sonuçları tamamen önleyemez. Bu nedenle kullanım aşağıdaki koşullara tabidir:',
    responsibilities: {
      title: 'Çalıştay Liderinin Sorumlulukları',
      supervision: 'Oturumun tamamı boyunca katılımcıları aktif olarak denetleyin.',
      ageAppropriate: 'Yaş grubuna uygun güvenlik seviyesini ayarlayın.',
      misuse: 'Katılımcıların güvenlik mekanizmalarını kötüye kullanmasını ve kasıtlı olarak atlatmasını önleyin.',
      context: 'Platformu gruplarla kullanmadan önce kendiniz test edin.',
      noGuarantee: 'Hiçbir teknik sistem pedagojik denetimin yerini alamaz.',
    },
    checkbox: 'Bu koşulları kabul ediyorum ve bu platformun denetimli kullanımından çalıştay lideri olarak sorumluluğu üstleniyorum.',
  ...
  multiImage: {
    ...
    defaultPrompt: 'Bu görselleri sahneli bir tanımlamaya dönüştür',
  ...
  imageTransform: {
    ...
    defaultPrompt: 'Bu görseli sahneli bir tanımlamaya dönüştür',
    uploadMode: 'Yükle',
    sketchMode: 'Eskiz',
    ...
    configs: {
      qwenImg2img: {
        name: 'QWEN Görsel Düzenleme'
      },
      wan22I2v: {
        name: 'WAN 2.2 Görselden Videoya (14B)'
      },
      hunyuan3d: {
        label: 'Hunyuan\n3D',
        name: 'Hunyuan3D-2 Görselden 3D\'ye'
      },
      sd35Img2img: {
        name: 'SD 3.5 Large Görselden Görsele'
      }
    },
    yourImage: 'Görseliniz',
    printTitle: 'Yazdır: Dönüştürülmüş Görsel',
    downloadError: 'İndirme başarısız',
    analysisFailed: 'Görsel analizi başarısız',
    analysisError: 'Görsel analizi sırasında hata',
  },
  textTransform: {
    ...
    selectMedium: 'Bir ortam seçin',
    selectModel: 'Bir model seçin',
    runCode: 'Kodu çalıştır',
    p5jsCode: 'P5.js Kodu',
    livePreview: 'Canlı Önizleme',
    tonejsCode: 'Tone.js Kodu',
    audioPlayer: 'Ses Oynatıcı',
    forwardToImage: 'Görsel Dönüşümüne İlet',
    yourImage: 'Görseliniz',
    pleaseSelectModel: 'Lütfen bir model seçin',
    saveSoon: 'Kaydetme özelliği yakında geliyor!',
    categories: {
      image: 'Görsel',
      video: 'Video',
      sound: 'Ses',
  ...
  latentLab: {
    ...
    imageLab: {
      ...
      tabs: {
        ...
        composable: {
          label: 'Bileşimli Difüzyon',
          short: 'Çok kavramlı harmanlama'
        },
        arcimboldo: {
          label: 'Arcimboldo Mozaik',
          short: 'Dikkat haritasından foto-mozaik'
        }
      }
    },
    ...
    shared: {
      ...
      randomVariation: 'Rastgele varyasyon',
    ...
    arcimboldo: {
      headerTitle: 'Arcimboldo Mozaik \u2014 Modelin kendi sözcükleriyle resim yapmak',
      headerSubtitle: 'Bir görsel oluşturun, modelin onu anlama göre parçalara bölmesini sağlayın, ardından her anlamsal bölgeyi o kavrama ait küçük yapay zeka üretimi karolarla değiştirin \u2014 masanın küçük masa görsellerinden oluşturulduğu bir foto-mozaik.',
      explanationToggle: 'Ayrıntılı açıklamayı göster',
      explainWhatTitle: 'Bu araç ne yapar?',
      explainWhatText: 'Portreleri meyve, sebze ve nesnelerden oluşturarak boyayan Giuseppe Arcimboldo\'nun adını taşıyan bu araç, yapay zeka üretimi görsellerden foto-mozaikler oluşturur. İlk olarak model bir görsel üretir ve prompttaki hangi kelimenin hangi görsel bölgeyi etkilediğini ortaya koyar (dikkat haritaları aracılığıyla). Ardından her anlamsal bölge, o kavrama ait birçok küçük yapay zeka üretimi karoyla değiştirilir. Sonuç, uzaktan orijinal görsel gibi okunan ancak yakından bakıldığında her bölgenin kendi kavramından oluştuğunu gösteren bir mozaiktir.',
      explainHowTitle: 'Nasıl çalışır?',
      explainHowText: 'Adım 1: SD3.5 ile görsel üretin ve dikkat haritalarını çıkarın (Dikkat Kartografisi ile aynı). Adım 2: Kazanan-alır segmentasyonu her uzamsal konumu en yüksek dikkate sahip kelimeye atar. Adım 3: Her anlamsal bölge için o kavramın küçük karo görsellerini oluşturun, orijinale renk uyumu sağlayın. Adım 4: Karoları bir mozaik ızgarasında birleştirin.',
      techTitle: 'Teknik detaylar',
      techText: '3 transformatör katmanından (erken/orta/geç) 64\u00d764 uzamsal çözünürlükte dikkat haritaları yakalanır. Segmentasyon, görüntünün %2\'sinden küçük bölgeleri birleştirmek için morfolojik temizlemeyle kazanan-alır kullanır. Karolar hız için azaltılmış adımlarla (8) 512\u00d7512\'de üretilir, ardından LAB uzayında her bölgenin ortalama rengiyle eşleştirmek üzere renk aktarımı uygulanır. Izgara ataması hücre başına çoğunluk oyu kullanır.',
      step1Title: 'Adım 1 \u2014 Görsel + dikkat haritaları oluştur',
      step2Title: 'Adım 2 \u2014 Anlamsal bölgeler',
      step3Title: 'Adım 3 \u2014 Karo üretimi',
      step4Title: 'Adım 4 \u2014 Mozaik sonucu',
      promptPlaceholder: 'örn. Bahçede masanın üzerinde oturan bir kedi',
      gridSizeLabel: 'Mozaik ızgarası',
      settingsToggle: 'Gelişmiş ayarlar',
      stepsLabel: 'Adımlar',
      cfgLabel: 'CFG',
      seedLabel: 'Tohum',
      generateBtn: 'Oluştur + Böl',
      generatingStatus: 'Görsel oluşturuluyor ve dikkat haritaları çıkarılıyor...',
      segmentingStatus: 'Anlamsal bölgeler bölünüyor...',
      generateTilesBtn: 'Tüm bölgeler için karo oluştur',
      tilesStatus: 'Karolar oluşturuluyor: {done} / {total}',
      originalLabel: 'Orijinal',
      mosaicLabel: 'Mozaik',
      blendLabel: 'Harmanlama',
      downloadBtn: 'Mozaiği indir',
      resetBtn: 'Başa dön',
    },
    composable: {
      headerTitle: 'Bileşimli Difüzyon \u2014 Her kavram için ayrı enerji',
      headerSubtitle: 'Tüm promptunuzu tek bir yekpare vektör olarak kodlamak yerine, her kavram gürültü giderme sırasında kendi transformatör geçişini alır. Gürültü tahminleri sizin kontrolündeki ağırlıklarla harmanlanır.',
      explanationToggle: 'Ayrıntılı açıklamayı göster',
      explainWhatTitle: 'Bu araç ne yapar?',
      explainWhatText: 'Standart görsel üretim, tüm promptunuzu tek bir temsile sıkıştırır. Model "gölün kenarında kırmızı bir ev"i tek bir bütünleşik kavram olarak görür. Bileşimli Difüzyon bunu parçalara ayırır: "kırmızı ev" ve "göl" her gürültü giderme adımında sinir ağından kendi eksiksiz işleme geçişini alır. Gürültü tahminleri daha sonra ayarlanabilir ağırlıklarla birleştirilir. Bu, her kavrama kendi "enerji işlevi"ni \u2014 görüntünün nasıl görünmesi gerektiği konusunda kendi oyunu \u2014 verir.',
      explainHowTitle: 'Teknik olarak nasıl çalışır?',
      explainHowText: '25 gürültü giderme adımının her birinde model N+1 transformatör geçişi çalıştırır: negatif prompt için bir (koşulsuz) ve her kavram için bir. Her kavram kendi gürültü tahminini üretir. Bunlar ağırlık ayarlarınız kullanılarak harmanlanır: noise_composed = w1\u00d7noise_1 + w2\u00d7noise_2 + ... Oluşturulan gürültü daha sonra sınıflandırıcısız yönlendirme (CFG) ve zamanlayıcı adımıyla kullanılır. Sonuç, her kavramın bağımsız olarak katkıda bulunduğu bir görseldir.',
      techTitle: 'Teknik detaylar',
      techText: 'Liu vd. (2022) esas alınmaktadır. Her kavram, tüm üç SD3.5 kodlayıcısıyla bağımsız olarak kodlanır (CLIP-L, OpenCLIP-G, T5-XXL). Özel gürültü giderme döngüsü, ağırlıklandırılıp toplanan kavram başına gürültü tahminleri üreterek adım başına kavram başına pipe.transformer() çağırır. VRAM: model ağırlıkları geçişler arasında paylaşılır; yalnızca aktivasyonlar değişir. 4 kavramla üretim standarttan yaklaşık 4 kat uzun sürer (her adım 2 yerine 5 transformatör geçişi gerektirir).',
      referencesTitle: 'Araştırma Kaynakları',
      conceptLabel: 'Kavram {n}',
      conceptPlaceholder: 'örn. tepede kırmızı bir ev',
      weightLabel: 'Ağırlık',
      removeBtn: 'Kaldır',
      addConceptBtn: 'Kavram ekle',
      settingsToggle: 'Gelişmiş ayarlar',
      negativePromptLabel: 'Negatif Prompt',
      negativePromptPlaceholder: 'örn. bulanık, metin, filigran',
      stepsLabel: 'Adımlar',
      cfgLabel: 'CFG',
      seedLabel: 'Tohum',
      normalizeLabel: 'Ağırlıkları normalleştir (toplam 1,0)',
      generateBtn: 'Oluştur',
      generating: 'Bileşimli üretim devam ediyor...',
      resultInfo: '{concepts} kavram | {time} | tohum {seed}',
      downloadBtn: 'İndir',
    },
    archaeology: {
    ...
    textLab: {
      ...
      bias: {
        ...
        referencesTitle: 'Araştırma Kaynakları',
        scenarioQwen: 'Qwen ailesi',
        scenarioMixed: 'Karma aileler',
        scenarioQwenHint: 'Aynı model ailesi, farklı boyutlar — ölçeğin önyargıyı nasıl etkilediğini izole eder.',
        scenarioMixedHint: 'Farklı model aileleri, benzer boyutlar — tokenleyici ve eğitim verilerinin önyargıyı nasıl etkilediğini izole eder.',
    ...
    crossmodal: {
      ...
      synth: {
        ...
        steps: 'Adımlar',
        cfg: 'CFG',
        durationHint: 'Üretilen ses klibinin saniye cinsinden uzunluğu (0,1–5,0)',
        startPosition: 'Başlangıç Konumu',
        startPositionHint: '%0 = atış/başlangıç, yüksek = süregelen/durağan materyal',
        stepsHint: 'Gürültü giderme adımları. Daha fazla = daha yüksek kalite.',
        cfgHint: 'Ses üretimi için Classifier-Free Guidance',
        seedHint: '-1 = rastgele, sabit değer = tekrarlanabilir sonuç',
        loop: 'Döngü oynatma',
        engineLooper: 'Looper',
        engineWavetable: 'Dalga Tablosu',
        loopOff: 'Tek çalım',
        loopToggle: 'Döngü',
        stop: 'Durdur',
        looping: 'Döngüde',
        ...
        extractionRegion: 'Çıkarım bölgesi',
        ...
        wavetableExtract: 'Örnekten',
        wtReextract: 'Yeniden çıkar',
        wavetableSemantic: 'Eksenden',
        wtSelectAxis: '— eksen seçin —',
        wtBuild: 'Oluştur',
        wtBuilding: 'Oluşturuluyor...',
        wtBuildHint: 'Anlamsal sıraya göre dalga tablosu oluşturmak için eksen boyunca kısa örnekler üretir',
        ...
        wtRange: 'Aralık',
        wtInterpolate: 'İnterpolasyon',
        wtScanEnvelope: 'Tarama',
        wtSweep: 'Süpürme',
        wtReturn: 'Geri Dön',
        ...
        sequencer: {
          ...
          gridHint: 'Kaydırıcı = yarım ton ofseti, nokta = aktif anahtar, G = glide, alt = hız',
          glideTime: 'Glide',
          patterns: {
        ...
        filter: {
          ...
          resonance: 'Rezonans',
          mix: 'Karışım',
          kbdTrack: 'Klavye İzleme',
          envelope: 'Filtre Zarfı',
          envAmount: 'Miktar',
          lfoRate: 'LFO Hızı',
          lfoDepth: 'LFO Derinliği',
          amplitude: 'Genlik',
        },
        preset: {
          export: 'Önayar dışa aktar',
        ...
        dimensions: {
          ...
          hintRelative: 'Yukarı sürükle = Prompt A\'ya doğru, aşağı sürükle = Prompt B\'ye doğru. Her çubuk boyut başına iki prompt arasında karışım yapar.',
          modeRelative: 'Göreceli',
          modeAbsolute: 'Mutlak',
        ...
        semanticAxes: {
          ...
          slotNone: '— yok —',
          groupSemantic: 'Anlamsal (metin kutupları)',
          groupPCA: 'PCA (veriye dayalı)',
  ...
  edutainment: {
    ...
    denoising: {
      ...
      modelLoadingVram: 'Model yükleniyor... {used} / {expected} GB VRAM',
      cloudProcessing: 'Bulut API\'sine istek gönderiliyor...',
      encodingClipL: 'CLIP-L metninizi okuyor... ({count} token)',
      encodingClipG: 'CLIP-G metninizi okuyor... ({count} token)',
      encodingT5: 'T5-XXL metninizi okuyor... ({count} token)',
      encodingEmbeddings: 'Gömme vektörleri oluşturuluyor...',
      encodingDenoisingStarts: 'Gürültü giderme başlıyor...',
    },
    energy: {
  ...
  provenance: {
    ...
    madeBy: 'Yapan:',
    learnedFrom: 'Öğrendiği kaynak:',
    howBig: 'Ne kadar büyük:',
    kidsNote: 'Tüm içerik üreticilerinden yapay zekanın çalışmalarından öğrenip öğrenemeyeceği sorulmadı.',
    publisher: 'Yayıncı',
    architecture: 'Mimari',
    parameters: 'Parametreler',
    license: 'Lisans',
    ...
    knownBiases: 'Bilinen Önyargılar',
    knownGaps: 'Bilinen Boşluklar',
    youthReflection: 'Her modelin eğitim verisiyle şekillenmiş bir perspektifi vardır. Hangi sesler eksik olabilir?',
  },
  persona: {
    title: 'Persona',
    inputPlaceholder: 'Bir şeyler söyle...',
    toggleTTS: 'Ses çıkışını aç/kapat',
    fallbackGreeting: 'Merhaba, ben Persona. Ben bir makineyim. Asistan değil. Benimle konuş.',
    newDialog: 'Yeni diyalog',
    description: 'Persona, konuşabileceğiniz bir yapay zekadır. Konuşma sırasında görsel, ses, video veya 3D nesne üretip üretmeyeceğine karar verir. Görüşleri vardır ve reddedebilir.',
    activate: 'Konuşmayı Başlat',
  },
  compare: {
    activation: {
      button: 'Trashy\'yi Etkinleştir',
      language: 'Aynı prompt, farklı diller, farklı görseller. Bu mod, dilin yapay zekanın ürettiklerini şekillendiren kültürel varsayımları nasıl kodladığını gösterir.',
      model: 'Aynı prompt, farklı modeller, farklı varsayımlar. Her modelin varsayılan insan, aile veya mesleği nasıl ele aldığını ortaya koyar.',
      systemprompt: 'Aynı mesaj, üç farklı sistem promptuyla. Görünmez talimatların aynı yapay zekayı farklı kişiliklere nasıl dönüştürdüğünü gösterir.',
      'llm-model': 'Aynı soru üç farklı AI modeline. Eğitim verilerinin, güvenlik politikalarının ve kültürel varsayımların nerede farklı yanıtlar ürettiğini gösterir.',
      temperature: 'Aynı mesaj, üç farklı rastgelelik seviyesinde: deterministik, dengeli, yaratıcı. Olasılık örneklemesinin yapay zeka çıktısını nasıl değiştirdiğini gösterir.',
      'vlm-analysis': 'Bir görsel yükleyin ve birden fazla görme modeli onu tanımlatın. Her modelin neye dikkat ettiğini, neyi görmezden geldiğini ve açıklamaların nerede ayrıştığını ortaya koyar.',
    },
    tabs: {
      model: 'Model Önyargısı',
      language: 'Kültür Önyargısı',
      'vlm-analysis': 'Görsel Anlama',
      'llm-model': 'Model Önyargısı',
      systemprompt: 'Sistem Promptları',
      temperature: 'Sıcak & Soğuk',
    },
    shared: {
      sendAll: 'Hepsine Gönder',
      sending: 'Gönderiliyor...',
      newConversation: 'Yeni konuşma',
      noResponse: 'Yanıt alınamadı',
      error: 'Bağlantı hatası',
      modelLabel: 'Model',
      defaultModel: 'Varsayılan (Ayarlar)',
      modelNotDownloaded: '(indirilmedi)',
    },
    temperature: {
      inputLabel: 'Mesajınız',
      inputPlaceholder: 'Üç sıcaklık seviyesinde göndermek için bir mesaj yazın...',
      cold: 'Deterministik',
      warm: 'Dengeli',
      hot: 'Yaratıcı',
      subtitle: 'Rastgeleliğin yapay zekanın söylediklerini nasıl değiştirdiğini görün',
    },
    systemprompt: {
      inputLabel: 'Mesajınız',
      inputPlaceholder: 'Üç sistem promptuyla birlikte göndermek için bir mesaj yazın...',
      subtitle: 'Görünmez talimatların yapay zeka davranışını nasıl kontrol ettiğini görün',
      presetLabel: 'Hazır Ayar',
      promptLabel: 'Sistem Promptu',
      emptyPrompt: '(sistem promptu yok)',
      custom: 'Özel',
      presets: {
        none: 'Sistem promptu yok',
        claude: 'Claude Sonnet 4.6 (2025)',
        gpt4_2023: 'GPT-4 (2023)',
        helpful: 'Yardımsever asistan',
        disagree: 'Her zaman karşı çık',
        pirate: 'Korsan',
        poet: 'Şair',
        fiveyearold: 'Beş yaşında çocuk',
        factsonly: 'Yalnızca gerçekler',
      },
    },
    llmModel: {
      inputLabel: 'Mesajınız',
      inputPlaceholder: 'Üç modele göndermek için bir mesaj yazın...',
      systemPromptLabel: 'SİSTEM PROMPTU',
    },
    vlmAnalysis: {
      imageLabel: 'Görseliniz',
      perspectiveLabel: 'Perspektif',
      modelsLabel: 'Görme Modelleri',
      noModelsInstalled: 'Yerel olarak yüklü görme modeli yok.',
      analyzeBtn: 'Görseli Analiz Et',
      analyzing: 'Analiz ediliyor...',
      waiting: 'bekleniyor',
      freePromptPlaceholder: 'Kendi analiz promptunuzu yazın...',
      perspectives: {
        free: 'Serbest (kendi promptunuz)',
        neutral: 'Tarafsız açıklama',
        safety: 'Güvenlik kontrolü',
        bildwissenschaftlich: 'Sanat tarihsel (Panofsky)',
        ikonik: 'İkonik analiz (Imdahl)',
        bildungstheoretisch: 'Eğitim teorisi (Joerissen/Marotzki)',
        ethisch: 'Etik analiz',
        kritisch: 'Dekolonyal / Eleştirel',
      },
    },
    promptLabel: 'Fikriniz',
    promptPlaceholder: 'Bir prompt girin — ör. "Çiçeklerle güzel bir bahçe"',
    platformLanguages: 'Platform Dilleri',
    furtherLanguages: 'Diğer Diller',
    selectHint: '{max} dilden {count} tanesi seçildi',
    modelLabel: 'Model',
    generateAll: 'Hepsini Karşılaştır',
    generatingAll: 'Oluşturuluyor...',
    generating: 'Oluşturuluyor...',
    waiting: 'Bekleniyor...',
    chatPlaceholder: 'Trashy\'ye sor...',
    trashyGreeting: 'Merhaba! Farklı dillerin nasıl farklı görseller ürettiğini keşfetmenize yardımcı olabilirim. Bir prompt girin ve en az 2 dil seçin — ne olduğunu açıklayacağım.',
    trashyTranslating: 'Promptunuz seçilen dillere çevriliyor...',
    trashyGenerating: 'Şimdi görseller oluşturuluyor — aynı seed, aynı model, yalnızca dil değişiyor. Ne olduğunu izleyin!',
    trashyTranslateError: 'Çeviri hizmeti şu an kullanılamıyor. Backend sunucusunun yeniden başlatılması gerekebilir.',
    trashyError: 'Bir şeyler yanlış gitti. Ayrıntılar için tarayıcı konsoluna bakın veya kurs eğitmenine sorun.',
    favorite: 'Favorilere ekle',
    unfavorite: 'Favorilerden kaldır',
    forward: 'Görsel dönüşümüne ilet',
    download: 'Görseli indir',
    analyze: 'Görseli analiz et',
  },
  workshop: {
    title: 'Çalıştay Planlaması',
    memory: {
      label: 'Grafik Kartı Belleği (VRAM)',
      system: 'Sistem',
      free: 'serbest',
      used: '{used} / {total} Gigabayt kullanımda',
      overBudget: '— sığmıyor!',
    },
    models: {
      label: 'Modeller — belleğe sürükleyin veya etkinleştirmek için tıklayın',
      image: 'Görseller',
      video: 'Videolar',
      music: 'Müzik',
      sound: 'Sesler',
      threeD: '3D',
      needsGb: '{gb} Gigabayt gerekiyor',
      loaded: '(yüklü)',
      cloudUs: 'Sunucu tabanlı — VRAM\'a yüklenmez',
      cloudEu: 'Sunucu tabanlı — VRAM\'a yüklenmez',
    },
    confirm: {
      load: 'Modelleri şimdi belleğe yükle',
      loading: 'Modeller yükleniyor...',
      ready: 'Hepsi yüklendi — hazır!',
      resultLoaded: 'Yüklendi: {models}',
      resultSkipped: 'İlk kullanımda: {models}',
      resultError: 'Hata: {details}',
    },
    actions: {
      clearAll: 'Tüm GPU belleğini temizle',
      confirmUnload: '{name} kaldırılsın mı? Bu, bu modeli kullanan tüm çalışan üretimleri durduracak.',
      confirmUnloadComfyui: '{name} kaldırıldığında TÜM ComfyUI modelleri bellekten silinecek (ComfyUI model bazında kaldırmayı desteklemiyor). Devam edilsin mi?',
      confirmClearAll: 'Bu, tüm çalışan süreçleri durduracak ve TÜM modelleri bellekten kaldıracak. Devam edilsin mi?',
    },
    chat: {
      cloudAdded: '{name}, {region}\'daki {publisher} sunucularında çalışıyor. Grafik kartında yer gerektirmez, ancak girişleriniz oraya gönderilir. Her sonuç proje bütçesinden para harcatır.',
      overBudget: '{name}, {gb} Gigabayt gerektiriyor. Bu belleğe sığmıyor! Başka bir modeli kaldırmanız ya da {name}\'i atlamanız gerekiyor.',
      freeSpace: '{name}, {gb} Gigabayt gerektiriyor. {free} Gigabayt kaldı.',
      connectionError: 'Bağlantı hatası — lütfen tekrar deneyin.',
      regionEu: 'Avrupa',
      regionUs: 'ABD',
      preloadStart: '{count} model belleğe yükleniyor. Bu birkaç dakika sürebilir — her model 30 saniye ile 2 dakika arası gerektirir.',
      preloadModel: '{name} yükleniyor...',
      preloadDone: '{name} yüklendi.',
      unloading: '{name} kaldırılıyor...',
      unloaded: '{name} kaldırıldı.',
      clearingAll: 'Tüm GPU belleği temizleniyor...',
      clearedAll: 'Tüm modeller kaldırıldı. GPU belleği serbest.',
    },
    greeting: {
      intro: 'Herkese merhaba. Ben Trashy, bu platformun yardım sistemi.',
      context: 'Çalıştay planlama sayfasındasınız. Bu mantıklı, çünkü başlamadan önce gerçekte ne yapmak istediğinizi kısaca düşünmeye değer.',
      resources: 'Yapay zeka modelleri şaşırtıcı derecede fazla kaynak gerektirir. Her şeyden önce grafik kartında bellek gerekir — görsellerinizi, videolarınızı ve seslerinizi hesaplayan işlem birimi. Bu bellek büyük ama sonsuz değil. Kullanmak istediğiniz modeller ise o kadar kapsamlı ki hızla doluyor.',
      planning: 'Biri bellek doluyken yeni bir model etkinleştirdiğinde uzun bekleme süreleri yaşanabilir. Yalnızca bir modeli yüklemek 30 saniye ile 2 dakika arasında sürer. Yüklendikten sonra her şey genellikle çok hızlı gider.',
      flexibility: 'Tabii ki bu sayfaya dönmeden istediğiniz zaman başka modeller yükleyebilir veya geçiş yapabilirsiniz. Ama o zaman beklersiniz. İyi çalışma, ister sanatsal ister deneysel olsun, genellikle ne ile ve neden çalışacağınızı önceden düşünmekle başlar. Sonuçta sanatsal çalışıyorsanız, sadece yolda olduğu için tesadüfen karşınıza çıkan nesneyi almazsınız.',
      callToAction: 'Bu sayfadaki model kartlarına bakın. Bunları bellek çubuğuna sürükleyebilir ve nelerin bir arada sığdığını görebilirsiniz. Ya da oturumda ne yapmak istediğinizi söyleyin, hangi modellerin uygun olduğunu açıklayayım.',
    },
    activate: 'Trashy\'ye Sor',
  },
  trashy: {
    placeholder: 'Size nasıl yardımcı olabilirim?',
    greeting: 'Merhaba! Ben yapay zeka yardımcınızım. AI4ArtsEd hakkında sorular sorun veya promptunuz için tavsiye isteyin.',
    noResponse: 'Yanıt alınamadı.',
    thinking: 'Bir dakika...',
    sendError: 'Üzgünüm, mesaj gönderilirken hata oluştu. Lütfen tekrar deneyin.',
    sendTooltip: 'Mesaj gönder (Enter)',
    openTooltip: 'Yapay zeka yardımcısını aç (Trashy) — taşımak için sürükleyin, sıfırlamak için çift tıklayın',
    closeTooltip: 'Kapat',
    analysisReflectionLoading: 'Analize bakılıyor...',
    analysisReflectionError: 'Şu an bir yansıma oluşturamadım. Yukarıdaki analizi okumaya devam edebilirsiniz.',
  }
