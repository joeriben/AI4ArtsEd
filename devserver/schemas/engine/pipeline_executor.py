...
class PipelineExecutor:
    ...
    async def _execute_pipeline_steps(self, config_name: str, steps: List[PipelineStep], context: PipelineContext, tracker=None, *, resolved_config=None, safety_level=None) -> PipelineResult:
        ...
        if completed_steps:
            ...
            for key in ['image_paths', 'seed', 'model', 'media_type', 'parameters', 'filesystem_path', 'prompt_id', 'workflow_completed', 'legacy_workflow', 'media_files', 'outputs_metadata', 'workflow_json', 'download_all', 'chunk_name', 'chunk_type', 'image_data', 'audio_data', 'audio_format', 'video_data', 'video_format', 'mesh_data', 'mesh_format', 'size_bytes', 'model_id', 'backend', 'attention_data', 'probing_data', 'algebra_data', 'reference_image', 'result_image', 'archaeology_data']:
