export const uk = {
  ...
  generationError: {
    busy: 'ШІ зараз дуже зайнятий. Спробуй ще раз за мить!',
    offline: 'ШІ зараз недоступний.',
    unknown: 'Щось пішло не так. Будь ласка, спробуй ще раз.'
  },
  gallery: {
    title: 'Обране',
  ...
  mediaOutput: {
    ...
    model3dReady: '3D-модель згенеровано',
    model3dInteractive: 'Обертайте та масштабуйте 3D-модель дотиком або мишкою',
    downloadGlb: 'Завантажити 3D-модель (GLB)',
    print: 'Друк',
    analyze: 'Аналіз зображення',
    analyzing: 'Аналіз...',
    generatedImage: 'Згенероване зображення',
    mediaCreated: 'Медіафайл створено',
    analysisTitle: 'Аналіз зображення',
    close: 'Закрити',
    saveSoon: 'Зберегти (незабаром)',
    trashyReflection: 'Поговори з Trashy про:',
    forwardToImageTransform: 'Надіслати до трансформації зображень'
  },
  settings: {
    ...
    safety: {
      kidsTitle: 'Діти (8–13)',
      kidsDesc: 'Усі фільтри активні: §86a, GDPR, суворий захист контенту для дітей (без зображень жахів, без зображеного насильства, без відвертих зображень), VLM-перевірка зображень',
      youthTitle: 'Підлітки (14–18)',
      youthDesc: 'Усі фільтри активні: §86a, GDPR, захист контенту для старших підлітків (жорстоке насильство, кривава сцени, відверті зображення, ненависть, самоушкодження та тероризм заблоковані; неграфічні зображення жахів дозволені), VLM-перевірка зображень',
      adultTitle: 'Дорослі',
    ...
    models: {
      ...
      localModelsAvailable: '{count} локальних моделей доступно (введіть або оберіть зі списку)',
      stage1Text: 'Модель перекладу',
      stage2Interception: 'Модель трансформації',
      stage2Optimization: 'Модель оптимізації промптів',
      stage3: 'Модель безпеки',
      stage4Legacy: 'Застаріла модель',
      chatHelper: 'Модель чату',
      persona: 'Модель персони',
      imageAnalysis: 'Модель аналізу зображень',
      coding: 'Модель генерації коду'
    },
    api: {
      ...
      ionosEu: 'IONOS AI Model Hub (ЄС Берлін, DSGVO)',
      mammouthEu: 'Mammouth AI (базується в ЄС, DSGVO)',
      ...
      ionosInfo: 'IONOS AI Model Hub (ЄС)',
      ionosDsgvo: 'Відповідає DSGVO (дата-центр ЄС Берлін)',
      mammouthInfo: 'Mammouth AI (базується в ЄС)',
      mammouthDsgvo: 'Відповідає DSGVO (інфраструктура ЄС)',
    ...
    backendStatus: {
      ...
      hidden: 'приховано',
      localLlm: 'Локальний LLM',
      model: 'Модель',
      loadedModels: 'Завантажені моделі',
      foreignProcesses: 'Інші процеси GPU',
      noModelsLoaded: 'Моделі наразі не завантажені',
      vramUsage: 'VRAM',
      inUse: 'Використовується',
      idle: 'Бездіяльний',
      lastUsed: 'Останнє використання',
      command: 'Команда',
      foreignVram: 'Зовнішнє використання VRAM',
      showLoadedModels: 'Показати завантажені моделі',
      hideLoadedModels: 'Приховати завантажені моделі',
      showProcesses: 'Показати процеси',
      hideProcesses: 'Приховати процеси',
      ownModels: 'Власні моделі',
      pid: 'PID'
    },
    apiManagement: {
      loading: 'Завантаження даних використання API...',
      refresh: 'Оновити',
      refreshing: 'Оновлення...',
      activeProvider: 'Активний хмарний провайдер',
      noProvider: 'Хмарний провайдер не налаштовано (лише локально)',
      accountOverview: 'Огляд рахунку',
      currentSpend: 'Поточні витрати',
      budgetLimit: 'Ліміт бюджету',
      remaining: 'Залишок',
      unlimited: 'Необмежено',
      resetDate: 'Скидання бюджету',
      rateLimit: 'Обмеження запитів',
      billingError: 'Не вдалося отримати дані про оплату',
      localUsage: 'Локальне відстеження використання',
      noUsageData: 'Даних використання ще немає. Дані з\'являться після хмарних API-дзвінків.',
      calls: 'Дзвінки',
      inputTokens: 'Вхідні токени',
      outputTokens: 'Вихідні токени',
      estCost: 'Орієнт. вартість',
      byModel: 'За моделлю',
      byStage: 'За етапом',
      stage: 'Етап',
      model: 'Модель',
      ...
      configured: 'Налаштовано',
      notConfigured: 'Не налаштовано',
      modelAssignments: 'Призначення моделей',
      function: 'Функція'
    }
  },
  pipeline: {
  ...
  mediaInput: {
    ...
    t5UsesYourText: 'T5-XXL використовує ваш оригінальний текст безпосередньо',
    queueAhead: '{count} генерація перед вами | {count} генерацій перед вами',
    deviceBusy: 'На цьому пристрої вже виконується генерація.',
    cancelPrevious: 'Скасувати попередню генерацію',
  ...
  canvas: {
    ...
    outputDrawer: {
      title: 'Результати',
      emptyState: 'Запустіть робочий процес для отримання результатів'
    },
    zoomControls: {
      zoomIn: 'Збільшити',
      zoomOut: 'Зменшити',
      resetZoom: 'Скинути масштаб',
      fitToContent: 'За розміром вмісту'
    },
    stage: {
  ...
  about: {
    ...
    credits: {
      title: 'Подяки',
      emt140: 'Імпульсні відповіді пластинчастого реверберу: EMT-140 від Greg Hopkins / Hopkins Media Services (CC-BY)'
    },
    funding: {
      title: 'За підтримки'
    }
  ...
  legal: {
    ...
    privacy: {
      ...
      usage: 'Використання цієї платформи дозволено виключно для зареєстрованих партнерів UCDCAE AI LAB. Діють домовленості про захист даних, укладені в цьому контексті. Якщо у вас є питання, зверніться:',
      controller: {
        title: 'Відповідальна особа',
        content: 'Університет Фрідріха-Александра Ерланген-Нюрнберг (FAU), представлений президентом. Відповідальний за зміст: Prof. Dr. Benjamin Jörissen, Bismarckstraße 1a, 91054 Erlangen.'
      },
      dataProcessing: {
        title: 'Обробка даних',
        content: 'Ця платформа обробляє наступні дані для освітньо-дослідницьких цілей: ваші текстові введення (промпти), всі проміжні кроки трансформації (переклади, педагогічні трансформації, перевірки безпеки) та згенеровані медіавиходи (зображення, аудіо, відео, код). Ці дані зберігаються на сервері в псевдонімізованій формі та використовуються виключно для досліджень у галузі цифрової культурної мистецької освіти.'
      },
      deviceId: {
        title: 'Ідентифікація пристрою',
        content: 'У локальному сховищі вашого браузера (localStorage) генерується та зберігається випадковий ідентифікатор пристрою. Він поєднується з поточною датою для організації воркшоп-сесій по днях. Ідентифікує лише пристрій — не особу, яка ним користується. Кілька та мінливих користувачів можуть використовувати один пристрій. Щоденна ротація забезпечує коректне групування згенерованого контенту за сесіями воркшопу. З цим ідентифікатором не пов\'язані жодні персональні дані.'
      },
      uploads: {
        title: 'Завантажені зображення',
        content: 'Зображення, завантажені для трансформацій зображення-в-зображення, тимчасово зберігаються на сервері для обробки. Вони не включаються до постійного дослідницького набору даних та регулярно видаляються.'
      },
      cookies: {
        title: 'Файли cookie',
        content: 'Ця платформа використовує лише один технічно необхідний сесійний файл cookie (дійсний 24 години) для підтримки сесії, ініційованої пристроєм. Трекінгові, аналітичні або сторонні файли cookie не використовуються.'
      },
      externalServices: {
        title: 'Зовнішні сервіси',
        content: 'Генерація зображень, перевірки безпеки (безпека зображень, перевірки GDPR) та більшість AI-обробки виконуються локально на сервері. Для текстової AI-обробки (трансформація промптів, педагогічна інтерцепція) платформа використовує Mistral AI (базується в ЄС). Mistral налаштований за договором так, щоб введення не використовувались для навчання моделі. Під час трансформації промптів можуть здійснюватися запити до Wikipedia лише для читання. Жодні персональні дані або ідентифікатори пристроїв не включаються до зовнішніх API-запитів. Захист імен за GDPR: на всіх стандартних рівнях безпеки (kids, youth, adult) на кожному полі введення виконується багатоетапний GDPR-фільтр. Canvas-воркфлоу є дослідницько орієнтованою функцією; відповідальність за дотримання GDPR при використанні Canvas несе користувач.'
      },
      legalBasis: {
        title: 'Правова підстава',
        content: 'Обробка даних здійснюється на підставі ст. 6(1)(f) GDPR (законний інтерес у освітніх дослідженнях). Доступ до цієї платформи обмежений зареєстрованими партнерами UCDCAE AI LAB, на яких поширюються окремі угоди про захист даних.'
      },
      retention: {
        title: 'Зберігання даних',
        content: 'Згенерований контент та пов\'язані метадані зберігаються протягом тривалості дослідницького проєкту. Автоматичного видалення не передбачено. Ви можете в будь-який час подати запит на видалення ваших даних.'
      },
      rights: {
        title: 'Ваші права',
        content: 'Відповідно до GDPR, ви маєте право на доступ (ст. 15), виправлення (ст. 16), видалення (ст. 17), обмеження обробки (ст. 18), перенесення даних (ст. 20) та заперечення (ст. 21). Ви також маєте право подати скаргу до наглядового органу.'
      },
      fauReference: {
        title: 'Політика конфіденційності FAU',
        content: 'На додаток до цього специфічного для платформи повідомлення діє загальна політика конфіденційності Університету Фрідріха-Александра Ерланген-Нюрнберг. Її можна знайти за адресою:'
      }
    }
  },
  docs: {
  ...
  multiImage: {
    ...
    defaultPrompt: 'Перетвори ці зображення на сценічний опис',
  ...
  imageTransform: {
    ...
    defaultPrompt: 'Перетвори це зображення на сценічний опис',
    uploadMode: 'Завантажити',
    sketchMode: 'Ескіз',
    selectModel: 'Обери модель',
    categories: {
      image: 'Зображення',
      video: 'Відео',
      threeD: '3D',
    ...
    configs: {
      qwenImg2img: {
        name: 'QWEN Редагування зображень'
      },
      wan22I2v: {
        name: 'WAN 2.2 Зображення→Відео (14B)'
      },
      hunyuan3d: {
        label: 'Hunyuan\n3D',
        name: 'Hunyuan3D-2 Зображення→3D'
      },
      sd35Img2img: {
        name: 'SD 3.5 Large Зображення→Зображення'
      }
    },
    yourImage: 'Твоє зображення',
    printTitle: 'Друк: Трансформоване зображення',
    downloadError: 'Завантаження не вдалося',
    analysisFailed: 'Аналіз зображення не вдався',
    analysisError: 'Помилка під час аналізу зображення'
  },
  textTransform: {
    ...
    loadingDefault: 'Ваш промпт адаптується для обраної моделі. Кожна модель розуміє описи по-різному — ШІ оптимізує текст для найкращих результатів.',
    loadingSd35: 'SD3.5 має три текстових кодувальники. CLIP-L та CLIP-G оптимізуються для візуальної точності — T5-XXL отримує ваш оригінальний текст безпосередньо, зберігаючи ваш творчий задум.',
    loadingTranslateHint: 'Якщо ваш текст не англійською, спочатку скористайтеся кнопкою перекладу — модель найкраще працює з англомовним введенням.',
    selectMedium: 'Обери медіум',
    selectModel: 'Обери модель',
    runCode: 'Запустити код',
    p5jsCode: 'Код P5.js',
    livePreview: 'Прямий перегляд',
    tonejsCode: 'Код Tone.js',
    audioPlayer: 'Аудіоплеєр',
    forwardToImage: 'Надіслати до трансформації зображень',
    yourImage: 'Твоє зображення',
    pleaseSelectModel: 'Будь ласка, обери модель',
    saveSoon: 'Функція збереження незабаром!',
    categories: {
      image: 'Зображення',
      video: 'Відео',
      sound: 'Звук'
  ...
  surrealizer: {
    ...
    executeButton: 'Виконати',
    executingButton: 'Генерація...'
  },
  musicGeneration: {
  ...
  latentLab: {
    ...
    imageLab: {
      ...
      tabs: {
        ...
        composable: {
          ...
          short: 'Змішування кількох концептів'
        },
        arcimboldo: {
          label: 'Мозаїка Арчімбольдо',
          short: 'Фотомозаїка з уваги'
        }
      }
    },
    ...
    shared: {
      ...
      randomVariation: 'Випадкова варіація',
    ...
    arcimboldo: {
      headerTitle: 'Мозаїка Арчімбольдо — Малювання власним словником моделі',
      headerSubtitle: 'Згенеруйте зображення, нехай модель розіб\'є його за змістом, а потім замініть кожну семантичну область маленькими ШІ-плитками цього концепту — фотомозаїка, де стіл складається з крихітних зображень столу.',
      explanationToggle: 'Показати детальне пояснення',
      explainWhatTitle: 'Що робить цей інструмент?',
      explainWhatText: 'Названий на честь Джузеппе Арчімбольдо, який малював портрети з фруктів, овочів та предметів, цей інструмент створює фотомозаїки з ШІ-згенерованих зображень. Спочатку модель генерує зображення і показує, яке слово в промпті впливає на яку частину зображення (через карти уваги). Потім кожна семантична область замінюється багатьма маленькими ШІ-плитками цього концепту.',
      explainHowTitle: 'Як це працює?',
      explainHowText: 'Крок 1: Генерація зображення з SD3.5 та вилучення карт уваги. Крок 2: Сегментація переможця призначає кожну позицію слову з найвищою увагою. Крок 3: Для кожної семантичної області генеруються маленькі плитки-зображення цього концепту. Крок 4: Плитки збираються у мозаїчну сітку.',
      techTitle: 'Технічні деталі',
      techText: 'Карти уваги фіксуються з роздільністю 64×64 з 3 шарів трансформера. Сегментація використовує переможця з морфологічним очищенням. Плитки генеруються при 512×512 зі зниженими кроками для швидкості.',
      step1Title: 'Крок 1 — Генерація зображення + карти уваги',
      step2Title: 'Крок 2 — Семантичні області',
      step3Title: 'Крок 3 — Генерація плиток',
      step4Title: 'Крок 4 — Результат мозаїки',
      promptPlaceholder: 'напр. Кіт сидить на столі в саду',
      gridSizeLabel: 'Мозаїчна сітка',
      settingsToggle: 'Розширені налаштування',
      stepsLabel: 'Кроки',
      cfgLabel: 'CFG',
      seedLabel: 'Seed',
      generateBtn: 'Згенерувати + Сегментувати',
      generatingStatus: 'Генерація зображення та вилучення карт уваги...',
      segmentingStatus: 'Сегментація семантичних областей...',
      generateTilesBtn: 'Згенерувати плитки для всіх областей',
      tilesStatus: 'Генерація плиток: {done} / {total}',
      originalLabel: 'Оригінал',
      mosaicLabel: 'Мозаїка',
      blendLabel: 'Змішати',
      downloadBtn: 'Завантажити мозаїку',
      resetBtn: 'Почати спочатку'
    },
    composable: {
      headerTitle: 'Composable Diffusion — Окрема енергія для кожного концепту',
      headerSubtitle: 'Замість кодування всього промпту як одного монолітного вектора, кожен концепт отримує власний прохід через трансформер під час шумоочищення.',
      explanationToggle: 'Показати детальне пояснення',
      explainWhatTitle: 'Що робить цей інструмент?',
      explainWhatText: 'Стандартна генерація зображень стискає весь промпт в одне представлення. Composable Diffusion розбиває це: кожен концепт отримує власний повний прохід через нейронну мережу на кожному кроці шумоочищення. Їх прогнози шуму потім комбінуються з вагами, якими ви керуєте.',
      explainHowTitle: 'Як це працює технічно?',
      explainHowText: 'На кожному з 25 кроків шумоочищення модель виконує N+1 проходів трансформера: один для негативного промпту, і один для кожного концепту. Кожен концепт виробляє власний прогноз шуму. Вони змішуються з вашими вагами: noise_composed = w1×noise_1 + w2×noise_2 + ...',
      techTitle: 'Технічні деталі',
      techText: 'Базується на Liu та ін. (2022). Кожен концепт кодується всіма трьома кодувальниками SD3.5 незалежно. З 4 концептами генерація займає приблизно в 4 рази довше.',
      referencesTitle: 'Наукові джерела',
      conceptLabel: 'Концепт {n}',
      conceptPlaceholder: 'напр. червоний будинок на пагорбі',
      weightLabel: 'Вага',
      removeBtn: 'Видалити',
      addConceptBtn: 'Додати концепт',
      settingsToggle: 'Розширені налаштування',
      negativePromptLabel: 'Негативний промпт',
      negativePromptPlaceholder: 'напр. розмито, текст, водяний знак',
      stepsLabel: 'Кроки',
      cfgLabel: 'CFG',
      seedLabel: 'Seed',
      normalizeLabel: 'Нормалізувати ваги (сума до 1.0)',
      generateBtn: 'Згенерувати',
      generating: 'Composable генерація виконується...',
      resultInfo: '{concepts} концептів | {time} | seed {seed}',
    ...
    textLab: {
      ...
      bias: {
        ...
        referencesTitle: 'Наукові джерела',
        scenarioQwen: 'Сімейство Qwen',
        scenarioMixed: 'Змішані сімейства',
        scenarioQwenHint: 'Те саме сімейство моделей, різні розміри — ізолює вплив масштабу на упередженість.',
        scenarioMixedHint: 'Різні сімейства моделей, подібні розміри — ізолює вплив токенізатора та навчальних даних на упередженість.',
    ...
    crossmodal: {
      ...
      synth: {
        ...
        looperSection: 'Лупер / Секвенсер',
        loopToggle: 'Цикл',
        wavetableToggle: 'Хвильова таблиця',
        wavetableStatic: 'Статичний',
        wavetableDynamic: 'Динамічний (незабаром)',
        sequencerToggle: 'Секвенсер',
        oscillating: 'Осцилює',
        sequencing: 'Секвенсування',
        arpeggiator: 'Арпеджіатор',
        arpeggiatorPatterns: {
          up: 'Вгору',
          down: 'Вниз',
          updown: 'Вгору-вниз',
        ...
        sequencer: {
          ...
          stop: 'Стоп',
          bpm: 'BPM',
          bpmHint: 'Темп у ударах на хвилину (кроки 16-х нот)',
          preset: 'Пресет',
          midiSync: 'MIDI-синхронізація',
          gridHint: 'Повзунок = зсув у напівтонах, крапка = активний перемикач, знизу = динамічність',
          glideTime: 'Глайд',
          patterns: {
            eastcoast: 'Eastcoast',
            westcoast: 'Westcoast',
        ...
        dimensions: {
          ...
          hintRelative: 'Перетягніть вгору = до промпту A, вниз = до промпту B. Кожен стовпчик змішує між двома промптами по виміру.',
          modeRelative: 'Відносний',
          modeAbsolute: 'Абсолютний',
        ...
        semanticAxes: {
          modeToggle: 'Семантичні осі',
          info: 'Семантичні осі спрямовують вбудовування промпту в певні напрямки. Кожен повзунок інтерполює між двома текстовими полюсами у просторі T5. Більше активних осей = слабший ефект на кожну вісь. Рекомендовано: 3–5 осей.',
          slotNone: '— жодної —',
          groupSemantic: 'Семантичні (текстові полюси)',
          groupPCA: 'PCA (на основі даних)',
          resetAll: 'Скинути всі до центру',
          experimental: 'експериментальний'
        },
        engineLooper: 'Лупер',
        engineWavetable: 'Хвильова таблиця',
        extractionRegion: 'Область вилучення',
        loopOff: 'Одноразово',
        record: 'Запис',
        stopRecording: 'Стоп',
        testNote: 'Тест C3',
        startPosition: 'Початкова позиція',
        startPositionHint: '0% = атака/початок, вище = стале/стаціонарний матеріал',
        wavetableExtract: 'Із семплу',
        wavetableSemantic: 'З осі',
        wtSelectAxis: '— оберіть вісь —',
        wtBuild: 'Побудувати',
        wtBuilding: 'Побудова...',
        wtBuildHint: 'Генерує короткі семпли вздовж осі для створення семантично впорядкованої хвильової таблиці',
        wtReextract: 'Перевилучити',
        wtRange: 'Діапазон',
        wtInterpolate: 'Інтерполювати',
        wtScanEnvelope: 'Сканування',
        wtSweep: 'Розгортка',
        wtReturn: 'Повернути',
        filter: {
          title: 'Фільтр',
          ...
          mix: 'Мікс',
          kbdTrack: 'Kbd Track',
          envelope: 'Огинаюча фільтра',
          envAmount: 'Глибина',
          lfoRate: 'Швидкість LFO',
          lfoDepth: 'Глибина LFO',
          amplitude: 'Амплітуда'
        },
        preset: {
          export: 'Експорт пресету',
          import: 'Імпорт пресету'
        },
      },
      mmaudio: {
  ...
  edutainment: {
    ...
    denoising: {
      modelLoading: 'Завантаження моделі в пам\'ять GPU...',
      modelLoadingVram: 'Завантаження моделі... {used} / {expected} ГБ VRAM',
      cloudProcessing: 'Надсилання запиту до хмарного API...',
      modelCard: 'Профіль моделі',
      publisher: 'Видавець',
      architecture: 'Архітектура',
      parameters: 'Параметри',
      textEncoders: 'Текстові енкодери',
      quantization: 'Квантизація',
      vramRequired: 'Необхідно VRAM',
      resolution: 'Роздільна здатність',
      license: 'Ліцензія',
      fairCulture: 'Справедлива культура',
      safetyByDesign: 'Безпека за проектом',
      denoisingActive: 'Шумоподавлення виконується...',
      encodingClipL: 'CLIP-L читає твій текст... ({count} токенів)',
      encodingClipG: 'CLIP-G читає твій текст... ({count} токенів)',
      encodingT5: 'T5-XXL читає твій текст... ({count} токенів)',
      encodingEmbeddings: 'Створення вкладень...',
      encodingDenoisingStarts: 'Шумоочищення починається...'
    },
    energy: {
      ...
      expert_1: '⚡ Поточне споживання: {watts} Вт | Навантаження GPU: {util}% | Накопичено: {kwh} кВт·год (інтеграл за часом)',
  ...
  compare: {
    activation: {
      button: 'Активувати Trashy',
      language: 'Той самий промпт, різні мови, різні зображення. Цей режим показує, як мова кодує культурні замовчування, що визначають, що генерує ШІ.',
      model: 'Той самий промпт, різні моделі, різні припущення. Показує, що кожна модель вважає стандартною людиною, сім\'єю або професією.',
      systemprompt: 'Те саме повідомлення з трьома різними системними промптами. Показує, як невидимі інструкції перетворюють той самий ШІ на різні особистості.',
      temperature: 'Те саме повідомлення на трьох рівнях випадковості: детерміністичний, збалансований, творчий. Показує, як вибірка ймовірностей змінює результат ШІ.',
      'vlm-analysis': 'Завантаж зображення і нехай кілька моделей зору опишуть його. Розкриває, що кожна модель помічає, що ігнорує і де описи розходяться.',
      'llm-model': 'Те саме питання до трьох різних ШІ-моделей. Показує, де навчальні дані, правила безпеки та культурні припущення дають різні відповіді.'
    },
    tabs: {
      model: 'Упередженість моделей',
      language: 'Культурна упередженість',
      'vlm-analysis': 'Розуміння зображень',
      'llm-model': 'Упередженість моделей',
      systemprompt: 'Системні промпти',
      temperature: 'Гаряче & Холодне'
    },
    shared: {
      sendAll: 'Надіслати всім',
      sending: 'Надсилання...',
      newConversation: 'Нова розмова',
      noResponse: 'Відповіді не отримано',
      error: 'Помилка з\'єднання',
      modelLabel: 'Модель',
      defaultModel: 'За замовчуванням (Налаштування)',
      modelNotDownloaded: '(не завантажено)'
    },
    temperature: {
      inputLabel: 'Твоє повідомлення',
      inputPlaceholder: 'Введи повідомлення для надсилання при всіх трьох температурах...',
      cold: 'Детерміністичний',
      warm: 'Збалансований',
      hot: 'Творчий',
      subtitle: 'Дивись, як випадковість змінює те, що каже ШІ'
    },
    systemprompt: {
      inputLabel: 'Твоє повідомлення',
      inputPlaceholder: 'Введи повідомлення для надсилання з усіма трьома системними промптами...',
      subtitle: 'Дивись, як невидимі інструкції керують поведінкою ШІ',
      presetLabel: 'Пресет',
      promptLabel: 'Системний промпт',
      emptyPrompt: '(без системного промпту)',
      custom: 'Власний',
      presets: {
        none: 'Без системного промпту',
        claude: 'Claude Sonnet 4.6 (2025)',
        gpt4_2023: 'GPT-4 (2023)',
        helpful: 'Корисний асистент',
        disagree: 'Завжди не погоджується',
        pirate: 'Пірат',
        poet: 'Поет',
        fiveyearold: 'П\'ятирічна дитина',
        factsonly: 'Лише факти'
      }
    },
    llmModel: {
      inputLabel: 'Твоє повідомлення',
      inputPlaceholder: 'Введи повідомлення для надсилання до всіх трьох моделей...',
      systemPromptLabel: 'СИСТЕМНИЙ ПРОМПТ'
    },
    vlmAnalysis: {
      imageLabel: 'Твоє зображення',
      perspectiveLabel: 'Перспектива',
      modelsLabel: 'Моделі зору',
      noModelsInstalled: 'Локально не встановлено жодних моделей зору.',
      analyzeBtn: 'Аналізувати зображення',
      analyzing: 'Аналіз...',
      waiting: 'очікування',
      freePromptPlaceholder: 'Напиши власний промпт аналізу...',
      perspectives: {
        free: 'Вільний (власний промпт)',
        neutral: 'Нейтральний опис',
        safety: 'Перевірка безпеки',
        bildwissenschaftlich: 'Мистецтвознавча (Панофський)',
        ikonik: 'Іконічний аналіз (Імдаль)',
        bildungstheoretisch: 'Освітня теорія (Йоріссен/Мароцкі)',
        ethisch: 'Етичний аналіз',
        kritisch: 'Деколоніальний / Критичний'
      }
    },
    promptLabel: 'Твоя ідея',
    promptPlaceholder: 'Введи промпт — напр. "Прекрасний сад з квітами"',
    platformLanguages: 'Мови платформи',
    furtherLanguages: 'Інші мови',
    selectHint: '{count} з {max} мов обрано',
    modelLabel: 'Модель',
    generateAll: 'Порівняти все',
    generatingAll: 'Генерація...',
    generating: 'Генерація...',
    waiting: 'Очікування...',
    chatPlaceholder: 'Запитай Trashy...',
    trashyGreeting: 'Привіт! Я можу допомогти тобі дослідити, як різні мови дають різні зображення. Введи промпт і вибери принаймні 2 мови — я поясню, що відбувається.',
    trashyTranslating: 'Перекладаю твій промпт на обрані мови...',
    trashyGenerating: 'Тепер генерую зображення — той самий seed, та сама модель, лише мова змінюється. Дивись, що відбувається!',
    trashyTranslateError: 'Сервіс перекладу наразі недоступний. Можливо, потрібно перезапустити бекенд-сервер.',
    trashyError: 'Щось пішло не так. Перевір консоль браузера або запитай викладача.',
    favorite: 'Додати до обраного',
    unfavorite: 'Видалити з обраного',
    forward: 'Надіслати до трансформації зображень',
    download: 'Завантажити зображення',
    analyze: 'Аналізувати зображення'
  },
  provenance: {
    title: 'Про цю модель',
    madeBy: 'Створено:',
    learnedFrom: 'Навчалась на:',
    howBig: 'Розмір:',
    kidsNote: 'Не всіх авторів запитали, чи може ШІ навчатися на їхніх роботах.',
    publisher: 'Видавець',
    architecture: 'Архітектура',
    parameters: 'Параметри',
    license: 'Ліцензія',
    trainingData: 'Навчальні дані',
    safetyByDesign: 'Безпека за проектом',
    sources: 'Джерела даних',
    consent: 'Згода авторів',
    consentValues: {
      none: 'Відсутня',
      partial: 'Часткова',
      full: 'Повна',
    ...
    knownBiases: 'Відомі упередженості',
    knownGaps: 'Відомі прогалини',
    youthReflection: 'Кожна модель має свою перспективу, сформовану навчальними даними. Яких голосів може бракувати?'
  },
  persona: {
    title: 'Персона',
    inputPlaceholder: 'Скажи щось...',
    toggleTTS: 'Увімкнути/вимкнути голосовий вивід',
    fallbackGreeting: 'Привіт, я Персона. Я машина. Не асистент. Поговори зі мною.',
    newDialog: 'Новий діалог',
    description: 'Персона — це ШІ, з яким ти можеш розмовляти. Вона вирішує, чи генерувати зображення, звук, відео або 3D-об\'єкти під час розмови. Має свою думку і може відмовити.',
    activate: 'Почати розмову'
  },
  workshop: {
    title: 'Планування воркшопу',
    memory: {
      label: 'Пам\'ять відеокарти (VRAM)',
      system: 'Система',
      free: 'вільно',
      used: '{used} / {total} гігабайт використано',
      overBudget: '— не вміщується!'
    },
    models: {
      label: 'Моделі — перетягніть до пам\'яті або натисніть для активації',
      image: 'Зображення',
      video: 'Відео',
      music: 'Музика',
      sound: 'Звук',
      threeD: '3D',
      needsGb: 'потребує {gb} гігабайт',
      loaded: '(завантажено)',
      cloudUs: 'На сервері — не завантажується у VRAM',
      cloudEu: 'На сервері — не завантажується у VRAM'
    },
    confirm: {
      load: 'Завантажити моделі в пам\'ять зараз',
      loading: 'Завантаження моделей...',
      ready: 'Усе завантажено — готово до роботи!',
      resultLoaded: 'Завантажено: {models}',
      resultSkipped: 'При першому використанні: {models}',
      resultError: 'Помилка: {details}'
    },
    actions: {
      clearAll: 'Очистити всю пам\'ять GPU',
      confirmUnload: 'Вивантажити {name}? Це перерве будь-яку генерацію, що використовує цю модель.',
      confirmUnloadComfyui: 'Вивантаження {name} звільнить ВСІ моделі ComfyUI з пам\'яті (ComfyUI не підтримує вивантаження окремих моделей). Продовжити?',
      confirmClearAll: 'Це перерве всі поточні процеси та вивантажить ВСІ моделі з пам\'яті. Продовжити?'
    },
    chat: {
      cloudAdded: '{name} працює на серверах {publisher} у {region}. Не потребує місця на відеокарті, але твої введення туди надсилаються. Кожен результат коштує з бюджету проєкту.',
      overBudget: '{name} потребує {gb} гігабайт. Не вміщується в пам\'ять! Потрібно або видалити іншу модель, або пропустити {name}.',
      freeSpace: '{name} потребує {gb} гігабайт. Залишилось {free} гігабайт.',
      connectionError: 'Помилка з\'єднання — будь ласка, спробуй ще раз.',
      regionEu: 'Європа',
      regionUs: 'США',
      preloadStart: 'Завантаження {count} моделей у пам\'ять. Це може зайняти кілька хвилин — кожна модель потребує від 30 секунд до 2 хвилин.',
      preloadModel: 'Завантаження {name}...',
      preloadDone: '{name} завантажено.',
      unloading: 'Вивантаження {name}...',
      unloaded: '{name} вивантажено.',
      clearingAll: 'Очищення всієї пам\'яті GPU...',
      clearedAll: 'Усі моделі вивантажено. Пам\'ять GPU вільна.'
    },
    greeting: {
      intro: 'Привіт усім. Я Trashy, система допомоги цієї платформи.',
      context: 'Ви на сторінці планування воркшопу. Це має сенс, адже перед початком варто коротко подумати про те, що ви насправді хочете зробити.',
      resources: 'ШІ-моделі потребують напрочуд багато ресурсів. Насамперед — пам\'ять на відеокарті, яка обчислює ваші зображення, відео та звуки. Ця пам\'ять велика, але не безмежна. А моделі, які ви хочете використовувати, такі великі, що вона швидко заповнюється.',
      planning: 'Коли хтось активує нову модель, коли пам\'ять вже заповнена, можуть виникнути довгі очікування. Тільки завантаження моделі займає від 30 секунд до 2 хвилин. Після завантаження все зазвичай йде дуже швидко.',
      flexibility: 'Звісно, ви можете в будь-який час завантажити або переключитися на інші моделі без повернення на цю сторінку. Але тоді доведеться чекати. А добра робота, художня чи експериментальна, зазвичай починається з того, що заздалегідь думаєш про те, з чим хочеш працювати і чому.',
      callToAction: 'Подивіться на картки моделей на цій сторінці. Їх можна перетягнути в рядок пам\'яті та побачити, що підходить разом. Або розкажіть мені, що хочете робити на сесії, і я поясню, які моделі підходять.'
    },
    activate: 'Запитати Trashy'
  },
  trashy: {
    placeholder: 'Як я можу допомогти?',
    greeting: 'Привіт! Я твій ШІ-помічник. Постав питання про AI4ArtsEd або попроси поради щодо промпту.',
    noResponse: 'Відповіді не отримано.',
    thinking: 'Одну мить...',
    sendError: 'Вибач, сталася помилка при надсиланні повідомлення. Будь ласка, спробуй ще раз.',
    sendTooltip: 'Надіслати повідомлення (Enter)',
    openTooltip: 'Відкрити ШІ-помічника (Trashy) — перетягни для переміщення, подвійний клік для скидання',
    closeTooltip: 'Закрити',
    analysisReflectionLoading: 'Переглядаю аналіз...',
    analysisReflectionError: 'Зараз не вдалося згенерувати рефлексію. Ти все одно можеш прочитати аналіз вище.'
  },
  usageAgreement: {
    title: 'Угода про використання',
    text: 'Ця платформа використовує ШІ для генерації зображень, звуків та текстів для культурної освіти. Вбудовано широкі заходи безпеки — але жодна технічна система не може повністю запобігти несподіваним результатам. Тому використання підпорядковується таким умовам:',
    responsibilities: {
      title: 'Відповідальність ведучого воркшопу',
      supervision: 'Активно спостерігайте за учасниками протягом усього сеансу.',
      ageAppropriate: 'Встановіть рівень безпеки, відповідний до вікової групи.',
      misuse: 'Запобігайте зловживанням та навмисному обходу механізмів безпеки учасниками.',
      context: 'Протестуйте платформу самостійно перед використанням з групами.',
      noGuarantee: 'Жодна технічна система не може замінити педагогічний нагляд.'
    },
    checkbox: 'Я погоджуюся з цими умовами та приймаю відповідальність як ведучий воркшопу за supervised використання цієї платформи.',
