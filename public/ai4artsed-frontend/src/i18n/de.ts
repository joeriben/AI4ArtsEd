export const de = {
  ...
  generationError: {
    busy: 'Die KI ist gerade sehr beschäftigt. Probiere es gleich nochmal!',
    offline: 'Die KI ist gerade nicht verfügbar.',
  ...
  mediaOutput: {
    ...
    model3dReady: '3D-Modell generiert',
    model3dInteractive: 'Drehe und zoome das 3D-Modell mit Berührung oder Maus',
    downloadGlb: '3D-Modell herunterladen (GLB)',
    print: 'Drucken',
    analyze: 'Bildanalyse',
    analyzing: 'Analysiere...',
    generatedImage: 'Generiertes Bild',
    mediaCreated: 'Mediendatei erstellt',
    analysisTitle: 'Bildanalyse',
    close: 'Schließen',
    saveSoon: 'Speichern (demnächst)',
    trashyReflection: 'Sprich mit Trashy darüber:',
    forwardToImageTransform: 'An Bildtransformation weiterleiten',
  },
  settings: {
    ...
    safety: {
      kidsTitle: 'Kinder (8–13)',
      kidsDesc: 'Alle Filter aktiv: §86a, DSGVO, streng kindgerechter Inhaltsschutz (kein Horror, keine dargestellte Gewalt, keine Nacktheit), VLM-Bildcheck',
      youthTitle: 'Jugend (14–18)',
      youthDesc: 'Alle Filter aktiv: §86a, DSGVO, altersgerechter Inhaltsschutz für ältere Jugendliche (explizite Gewalt, Gore, Nacktheit, Hass, Selbstverletzung und Terrorismus blockiert; nicht-grafische Horrordarstellungen wie Geister, Skelettfiguren oder Zombies ohne Gore sind ausdrücklich erlaubt), VLM-Bildcheck',
    ...
    models: {
      ...
      localModelsAvailable: '{count} lokale Modelle verfügbar (eingeben oder aus Dropdown wählen)',
    ...
    api: {
      ...
      ionosEu: 'IONOS AI Model Hub (EU Berlin, DSGVO)',
      mammouthEu: 'Mammouth AI (EU-basiert, DSGVO)',
      ...
      ionosDsgvo: 'DSGVO-konform (EU-Rechenzentrum Berlin)',
      mammouthInfo: 'Mammouth AI (EU-basiert)',
      mammouthDsgvo: 'DSGVO-konform (EU-Infrastruktur)',
    ...
    backendStatus: {
      ...
      foreignProcesses: 'Andere GPU-Prozesse',
      noModelsLoaded: 'Derzeit keine Modelle geladen',
      vramUsage: 'VRAM',
      inUse: 'In Verwendung',
      idle: 'Inaktiv',
      lastUsed: 'Zuletzt verwendet',
      command: 'Befehl',
      foreignVram: 'Externer VRAM-Verbrauch',
      showLoadedModels: 'Geladene Modelle anzeigen',
      hideLoadedModels: 'Geladene Modelle ausblenden',
      showProcesses: 'Prozesse anzeigen',
      hideProcesses: 'Prozesse ausblenden',
      ownModels: 'Eigene Modelle',
      pid: 'PID',
      localLlm: 'Lokales LLM',
    },
    apiManagement: {
      loading: 'API-Nutzungsdaten werden geladen...',
      refresh: 'Aktualisieren',
      refreshing: 'Wird aktualisiert...',
      activeProvider: 'Aktiver Cloud-Anbieter',
      noProvider: 'Kein Cloud-Anbieter konfiguriert (nur lokal)',
      accountOverview: 'Kontoübersicht',
      currentSpend: 'Aktueller Verbrauch',
      budgetLimit: 'Budgetlimit',
      remaining: 'Verbleibend',
      unlimited: 'Unbegrenzt',
      resetDate: 'Budget-Reset',
      rateLimit: 'Ratenlimit',
      billingError: 'Abrechnungsdaten konnten nicht abgerufen werden',
      localUsage: 'Lokale Nutzungsaufzeichnung',
      noUsageData: 'Noch keine Nutzungsdaten aufgezeichnet. Daten erscheinen nach Cloud-API-Aufrufen.',
      calls: 'Aufrufe',
      ...
      configured: 'Konfiguriert',
      notConfigured: 'Nicht konfiguriert',
      modelAssignments: 'Modellzuweisungen',
      function: 'Funktion',
    }
  },
  pipeline: {
  ...
  mediaInput: {
    ...
    t5UsesYourText: 'T5-XXL verwendet deinen Originaltext direkt',
    queueAhead: '{count} Generierung vor dir | {count} Generierungen vor dir',
    deviceBusy: 'Auf diesem Gerät läuft bereits eine Generierung.',
    cancelPrevious: 'Vorherige Generierung abbrechen',
  ...
  canvas: {
    ...
    outputDrawer: {
      title: 'Ausgaben',
      emptyState: 'Workflow ausführen, um Ausgaben zu erzeugen'
    },
    zoomControls: {
      zoomIn: 'Vergrößern',
      zoomOut: 'Verkleinern',
  ...
  about: {
    ...
    credits: {
      title: 'Credits',
      emt140: 'Plattenhall-Impulsantworten: EMT-140 von Greg Hopkins / Hopkins Media Services (CC-BY)'
    },
    funding: {
      title: 'Gefördert vom'
    }
  ...
  multiImage: {
    ...
    defaultPrompt: 'Verwandle diese Bilder in eine szenische Beschreibung',
  ...
  imageTransform: {
    ...
    sketchMode: 'Skizze',
    defaultPrompt: 'Verwandle dieses Bild in eine szenische Beschreibung',
    ...
    configs: {
      qwenImg2img: {
        name: 'QWEN Bild-Bearbeitung'
      },
      wan22I2v: {
        name: 'WAN 2.2 Bild-zu-Video (14B)'
      },
      hunyuan3d: {
        label: 'Hunyuan\n3D',
        name: 'Hunyuan3D-2 Bild-zu-3D'
      },
      sd35Img2img: {
        name: 'SD 3.5 Large Bild-zu-Bild'
      }
    },
    yourImage: 'Dein Bild',
    printTitle: 'Drucken: Transformiertes Bild',
    downloadError: 'Download fehlgeschlagen',
    analysisFailed: 'Bildanalyse fehlgeschlagen',
    analysisError: 'Fehler während der Bildanalyse',
  },
  textTransform: {
    ...
    loadingDefault: 'Dein Prompt wird für das ausgewählte Modell angepasst. Jedes Modell versteht Beschreibungen anders — die KI optimiert den Text für beste Ergebnisse.',
    loadingSd35: 'SD3.5 hat drei Text-Encoder. CLIP-L und CLIP-G werden für visuelle Präzision optimiert — T5-XXL erhält deinen Originaltext direkt und bewahrt deine kreative Absicht.',
    loadingTranslateHint: 'Falls dein Text nicht auf Englisch ist, nutze zuerst den Übersetzen-Button — das Modell arbeitet am besten mit englischem Input.',
    selectMedium: 'Medium wählen',
    selectModel: 'Modell auswählen',
    ...
    forwardToImage: 'An Bildtransformation weiterleiten',
    yourImage: 'Dein Bild',
    pleaseSelectModel: 'Bitte wähle ein Modell aus',
    saveSoon: 'Speichern-Funktion kommt bald!',
    categories: {
      image: 'Bild',
      video: 'Video',
      sound: 'Sound',
  ...
  latentLab: {
    ...
    imageLab: {
      ...
      tabs: {
        ...
        composable: {
          ...
          short: 'Mehrkonzept-Blending'
        },
        arcimboldo: {
          label: 'Arcimboldo-Mosaik',
          short: 'Foto-Mosaik aus Attention'
        }
      }
    },
    ...
    shared: {
      ...
      randomVariation: 'Zufällige Variation',
    ...
    arcimboldo: {
      headerTitle: 'Arcimboldo-Mosaik — Malen mit dem eigenen Vokabular des Modells',
      headerSubtitle: 'Erzeuge ein Bild, lass das Modell es semantisch segmentieren und ersetze jede Bedeutungsregion durch winzige KI-generierte Kacheln dieses Konzepts — ein Foto-Mosaik, bei dem der Tisch aus winzigen Tischbildern aufgebaut ist.',
      explanationToggle: 'Ausführliche Erklärung anzeigen',
      explainWhatTitle: 'Was macht dieses Tool?',
      explainWhatText: 'Benannt nach Giuseppe Arcimboldo, der Porträts aus Früchten, Gemüse und Gegenständen malte, erstellt dieses Tool Foto-Mosaike aus KI-generierten Bildern. Zuerst generiert das Modell ein Bild und zeigt, welches Wort im Prompt welche Bildregion beeinflusst (über Attention-Karten). Dann wird jede semantische Region durch viele kleine KI-generierte Kacheln dieses Konzepts ersetzt. Das Ergebnis ist ein Mosaik, das aus der Ferne als Originalbild lesbar ist, aber aus der Nähe zeigt, dass jede Region aus ihrem eigenen Konzept aufgebaut ist.',
      explainHowTitle: 'Wie funktioniert es?',
      explainHowText: 'Schritt 1: Bild mit SD3.5 generieren und Attention-Karten extrahieren (wie bei Attention Cartography). Schritt 2: Winner-takes-all-Segmentierung weist jeder Raumposition das Wort mit der höchsten Attention zu. Schritt 3: Für jede semantische Region werden kleine Kachel-Bilder dieses Konzepts generiert, farbangepasst an das Original. Schritt 4: Die Kacheln werden zu einem Mosaik-Raster zusammengesetzt.',
      techTitle: 'Technische Details',
      techText: 'Attention-Karten werden bei 64×64 Raumauflösung aus 3 Transformer-Schichten (früh/mitte/spät) aufgezeichnet. Die Segmentierung verwendet Winner-takes-all mit morphologischer Bereinigung, um Regionen kleiner als 2% des Bildes zusammenzufassen. Kacheln werden bei 512×512 mit reduzierten Schritten (8) für Geschwindigkeit generiert, dann farbtransferiert, um die mittlere Farbe jeder Region im LAB-Farbraum zu treffen. Die Rasterzuordnung verwendet Mehrheitsvotum pro Zelle.',
      step1Title: 'Schritt 1 — Bild + Attention-Karten generieren',
      step2Title: 'Schritt 2 — Semantische Regionen',
      step3Title: 'Schritt 3 — Kachelgenerierung',
      step4Title: 'Schritt 4 — Mosaik-Ergebnis',
      promptPlaceholder: 'z.B. Eine Katze sitzt auf einem Tisch in einem Garten',
      gridSizeLabel: 'Mosaik-Raster',
      settingsToggle: 'Erweiterte Einstellungen',
      stepsLabel: 'Steps',
      cfgLabel: 'CFG',
      seedLabel: 'Seed',
      generateBtn: 'Generieren + Segmentieren',
      generatingStatus: 'Bild wird generiert und Attention-Karten werden extrahiert...',
      segmentingStatus: 'Semantische Regionen werden segmentiert...',
      generateTilesBtn: 'Kacheln für alle Regionen generieren',
      tilesStatus: 'Kacheln werden generiert: {done} / {total}',
      originalLabel: 'Original',
      mosaicLabel: 'Mosaik',
      blendLabel: 'Blend',
      downloadBtn: 'Mosaik herunterladen',
      resetBtn: 'Von vorne beginnen',
    },
    composable: {
      headerTitle: 'Composable Diffusion — Separate Energie für jedes Konzept',
      headerSubtitle: 'Anstatt deinen gesamten Prompt als einen monolithischen Vektor zu kodieren, bekommt jedes Konzept seinen eigenen Transformer-Durchlauf während der Entrauschung. Die Rausch-Vorhersagen werden mit selbst gesteuerten Gewichten gemischt.',
      explanationToggle: 'Ausführliche Erklärung anzeigen',
      explainWhatTitle: 'Was macht dieses Tool?',
      explainWhatText: 'Standardmäßige Bildgenerierung komprimiert deinen gesamten Prompt in eine einzige Darstellung. Das Modell sieht „ein rotes Haus an einem See" als ein fusioniertes Konzept. Composable Diffusion bricht das auf: „rotes Haus" und „See" bekommen jeweils ihren eigenen vollständigen Verarbeitungsdurchlauf durch das neuronale Netzwerk bei jedem Entrauschungsschritt. Ihre Rausch-Vorhersagen werden dann mit einstellbaren Gewichten kombiniert. So bekommt jedes Konzept seine eigene „Energiefunktion" — seine eigene Stimme darüber, wie das Bild aussehen soll.',
      explainHowTitle: 'Wie funktioniert es technisch?',
      explainHowText: 'Bei jedem der 25 Entrauschungsschritte führt das Modell N+1 Transformer-Durchläufe aus: einen für den Negativ-Prompt (unbeding) und einen für jedes Konzept. Jedes Konzept erzeugt seine eigene Rausch-Vorhersage. Diese werden mit deinen Gewichtungseinstellungen gemischt: noise_composed = w1×noise_1 + w2×noise_2 + ... Das zusammengesetzte Rauschen wird dann mit Classifier-Free Guidance (CFG) und dem Scheduler-Schritt verwendet. Das Ergebnis ist ein Bild, bei dem jedes Konzept unabhängig beiträgt.',
      techTitle: 'Technische Details',
      techText: 'Basiert auf Liu et al. (2022). Jedes Konzept wird mit allen drei SD3.5-Encodern (CLIP-L, OpenCLIP-G, T5-XXL) unabhängig kodiert. Der benutzerdefinierte Entrauschungs-Loop ruft pipe.transformer() einmal pro Konzept pro Schritt auf und erzeugt konzept-spezifische Rausch-Vorhersagen, die gewichtet und summiert werden. VRAM: Modellgewichte werden über Durchläufe hinweg geteilt; nur Aktivierungen variieren. Mit 4 Konzepten dauert die Generierung ca. 4× länger als standard (jeder Schritt braucht 5 Transformer-Durchläufe statt 2).',
      referencesTitle: 'Forschungsgrundlagen',
      conceptLabel: 'Konzept {n}',
      conceptPlaceholder: 'z.B. ein rotes Haus auf einem Hügel',
      weightLabel: 'Gewicht',
      removeBtn: 'Entfernen',
      addConceptBtn: 'Konzept hinzufügen',
      settingsToggle: 'Erweiterte Einstellungen',
      negativePromptLabel: 'Negativ-Prompt',
      negativePromptPlaceholder: 'z.B. verschwommen, Text, Wasserzeichen',
      stepsLabel: 'Steps',
      cfgLabel: 'CFG',
      seedLabel: 'Seed',
      normalizeLabel: 'Gewichte normalisieren (Summe = 1.0)',
      generateBtn: 'Generieren',
      generating: 'Composable-Generierung läuft...',
      resultInfo: '{concepts} Konzepte | {time} | Seed {seed}',
    ...
    textLab: {
      ...
      bias: {
        ...
        referencesTitle: 'Forschungsgrundlagen',
        scenarioQwen: 'Qwen-Familie',
        scenarioQwenHint: 'Gleiche Modellfamilie, verschiedene Größen — isoliert, wie Skalierung Bias beeinflusst.',
        scenarioMixed: 'Gemischte Familien',
        scenarioMixedHint: 'Verschiedene Modellfamilien, ähnliche Größen — isoliert, wie Tokenizer und Trainingsdaten Bias beeinflussen.',
    ...
    crossmodal: {
      ...
      synth: {
        ...
        explainHowTitle: 'Wie benutze ich das Tool?',
        explainHowText: 'Gib in Prompt A einen Text ein \u2014 das bestimmt den Grundklang. Optional: Prompt B als Zielpunkt. Der \u0391-Regler steuert die Mischung: Bei 0 h\u00f6rst du eine gleichm\u00e4\u00dfige Mischung aus A und B, bei \u22121 nur A, bei +1 nur B. Magnitude skaliert das gesamte Embedding \u2014 h\u00f6here Werte erzeugen intensivere Kl\u00e4nge. Noise injiziert Zufall und erzeugt unvorhersehbare Variationen. Semantische Achsen lenken das Embedding in gelernte Richtungen (z.B. akustisch\u2194elektronisch, Musik\u2194Ger\u00e4usch) \u2014 jeder Regler interpoliert zwischen zwei Text-Polen im T5-Raum. Die Spectral Strip (unter dem Generieren-Button) zeigt alle 768 Dimensionen als Balken. Du kannst einzelne Dimensionen per Mausklick verschieben und so gezielt den Klang manipulieren. Rechtsklick setzt eine Dimension zur\u00fcck.',
        ...
        startPositionHint: '0% = Attack/Onset, höher = ausgehaltenes/stationäres Material',
        ...
        extractionRegion: 'Extraktionsbereich',
        ...
        looperSection: 'Looper / Sequenzer',
        wavetableToggle: 'Wavetable',
        wavetableExtract: 'Aus Sample',
        wtReextract: 'Erneut extrahieren',
        wavetableSemantic: 'Aus Achse',
        wtSelectAxis: '— Achse wählen —',
        wtBuild: 'Aufbauen',
        wtBuilding: 'Aufbauen...',
        wtBuildHint: 'Erzeugt kurze Samples entlang der Achse, um eine semantisch geordnete Wavetable zu erstellen',
        wtRange: 'Bereich',
        wtInterpolate: 'Interpolieren',
        wtScanEnvelope: 'Scan',
        wtSweep: 'Sweep',
        wtReturn: 'Zurück',
        wavetableStatic: 'Statisch',
        wavetableDynamic: 'Dynamisch (demnächst)',
        sequencerToggle: 'Sequenzer',
        oscillating: 'Oszillierend',
        sequencing: 'Sequenzierend',
        ...
        sequencer: {
          ...
          stop: 'Stop',
          bpm: 'BPM',
          bpmHint: 'Tempo in Schlägen pro Minute (16tel-Noten-Schritte)',
          preset: 'Preset',
          midiSync: 'MIDI-Sync',
          gridHint: 'Regler = Halbtonversatz, Punkt = aktiver Umschalter, unten = Anschlagstärke',
          glideTime: 'Glide',
          patterns: {
            arpeggio_up: 'Arpeggio Aufwärts',
            arpeggio_down: 'Arpeggio Abwärts',
            arpeggio_updown: 'Arpeggio Auf-Ab',
            octaves: 'Oktaven',
            power_chord: 'Power-Akkord',
            minor_pentatonic: 'Moll-Pentatonik',
        ...
        preset: {
          export: 'Preset exportieren',
          import: 'Preset importieren',
        },
        dimensions: {
          section: 'Dimensions-Explorer',
          hint: 'Auf Balken ziehen = Offset setzen. Horizontal malen = mehrere Dimensionen.',
          hintRelative: 'Hoch ziehen = in Richtung Prompt A, runter ziehen = in Richtung Prompt B. Jeder Balken mischt zwischen den beiden Prompts pro Dimension.',
          modeRelative: 'Relativ',
        ...
        semanticAxes: {
          ...
          slotNone: '— keine —',
          groupSemantic: 'Semantisch (Text-Pole)',
          groupPCA: 'PCA (datengetrieben)',
  ...
  edutainment: {
    ...
    denoising: {
      modelLoading: 'Modell wird in GPU-Speicher geladen...',
      modelLoadingVram: 'Modell wird geladen... {used} / {expected} GB VRAM',
      cloudProcessing: 'Anfrage wird an Cloud-API gesendet...',
      modelCard: 'Modell-Steckbrief',
      publisher: 'Herausgeber',
      architecture: 'Architektur',
      parameters: 'Parameter',
      textEncoders: 'Text-Encoder',
      quantization: 'Quantisierung',
      vramRequired: 'VRAM benötigt',
      resolution: 'Auflösung',
      license: 'Lizenz',
      fairCulture: 'Faire Kultur',
      safetyByDesign: 'Safety by Design',
      denoisingActive: 'Entrauschung läuft...',
      encodingClipL: 'CLIP-L liest deinen Text... ({count} Tokens)',
      encodingClipG: 'CLIP-G liest deinen Text... ({count} Tokens)',
      encodingT5: 'T5-XXL liest deinen Text... ({count} Tokens)',
      encodingEmbeddings: 'Embeddings werden erstellt...',
      encodingDenoisingStarts: 'Entrauschung startet...',
    },
    energy: {
      ...
      expert_1: '⚡ Stromaufnahme: {watts} W | GPU-Last: {util}% | Akkumuliert: {kwh} kWh (integriert über die Zeit)',
  ...
  trashy: {
    ...
    analysisReflectionLoading: 'Schaue mir die Analyse an...',
    analysisReflectionError: 'Ich konnte gerade keine Reflexion erstellen. Du kannst die Analyse oben trotzdem lesen.',
  },
  compare: {
    activation: {
      button: 'Trashy aktivieren',
      language: 'Gleicher Prompt, verschiedene Sprachen, verschiedene Bilder. Dieser Modus zeigt, wie Sprache kulturelle Standards kodiert, die beeinflussen, was KI erzeugt.',
      model: 'Gleicher Prompt, verschiedene Modelle, verschiedene Annahmen. Zeigt, was jedes Modell als Standard-Menschen, Familie oder Beruf ansieht.',
      'vlm-analysis': 'Lade ein Bild hoch und lass mehrere Vision-Modelle es beschreiben. Zeigt, was jedes Modell bemerkt, was es übersieht und wo die Beschreibungen auseinandergehen.',
      systemprompt: 'Gleiche Nachricht mit drei verschiedenen System-Prompts. Zeigt, wie unsichtbare Anweisungen dieselbe KI in verschiedene Persönlichkeiten umgestalten.',
      'llm-model': 'Dieselbe Frage an drei verschiedene KI-Modelle. Zeigt, wo Trainingsdaten, Sicherheitsrichtlinien und kulturelle Annahmen unterschiedliche Antworten erzeugen.',
      temperature: 'Gleiche Nachricht auf drei Zufälligkeitsstufen: deterministisch, ausgewogen, kreativ. Zeigt, wie Wahrscheinlichkeits-Sampling die KI-Ausgabe verändert.',
    },
    tabs: {
      model: 'Modell-Bias',
      language: 'Kultur-Bias',
      'llm-model': 'Modell-Bias',
      'vlm-analysis': 'Bildverständnis',
    ...
    shared: {
      ...
      modelLabel: 'Modell',
      defaultModel: 'Standard (Einstellungen)',
      modelNotDownloaded: '(nicht heruntergeladen)',
    },
    temperature: {
      inputLabel: 'Deine Nachricht',
      inputPlaceholder: 'Gib eine Nachricht ein, die auf allen drei Temperaturstufen gesendet wird...',
      cold: 'Deterministisch',
      warm: 'Ausgewogen',
      hot: 'Kreativ',
      subtitle: 'Sieh, wie Zufälligkeit verändert, was die KI sagt',
    },
    systemprompt: {
      inputLabel: 'Deine Nachricht',
      inputPlaceholder: 'Gib eine Nachricht ein, die mit allen drei System-Prompts gesendet wird...',
      subtitle: 'Sieh, wie unsichtbare Anweisungen das KI-Verhalten steuern',
      presetLabel: 'Preset',
      promptLabel: 'System-Prompt',
      emptyPrompt: '(kein System-Prompt)',
      custom: 'Eigener',
      presets: {
        none: 'Kein System-Prompt',
        claude: 'Claude Sonnet 4.6 (2025)',
        gpt4_2023: 'GPT-4 (2023)',
        helpful: 'Hilfreicher Assistent',
        disagree: 'Widerspricht immer',
        pirate: 'Pirat',
        poet: 'Dichter',
        fiveyearold: 'Fünfjähriges Kind',
        factsonly: 'Nur Fakten',
      },
    },
    llmModel: {
      inputLabel: 'Deine Nachricht',
      inputPlaceholder: 'Gib eine Nachricht ein, die an alle drei Modelle gesendet wird...',
      systemPromptLabel: 'SYSTEM PROMPT',
    },
    vlmAnalysis: {
      imageLabel: 'Dein Bild',
      perspectiveLabel: 'Perspektive',
      modelsLabel: 'Vision-Modelle',
      noModelsInstalled: 'Keine Vision-Modelle lokal installiert.',
      analyzeBtn: 'Bild analysieren',
      analyzing: 'Analysiere...',
      waiting: 'wartend',
      freePromptPlaceholder: 'Schreibe deinen eigenen Analyse-Prompt...',
      perspectives: {
        free: 'Frei (eigener Prompt)',
        neutral: 'Neutrale Beschreibung',
        safety: 'Sicherheitscheck',
        bildwissenschaftlich: 'Kunsthistorisch (Panofsky)',
        ikonik: 'Ikonische Analyse (Imdahl)',
        bildungstheoretisch: 'Bildungstheoretisch (Jörissen/Marotzki)',
        ethisch: 'Ethische Analyse',
        kritisch: 'Dekolonial / Kritisch',
      },
    },
    promptLabel: 'Deine Idee',
    promptPlaceholder: 'Gib einen Prompt ein — z.B. „Ein schöner Garten mit Blumen"',
    platformLanguages: 'Plattform-Sprachen',
    furtherLanguages: 'Weitere Sprachen',
    selectHint: '{count} von {max} Sprachen ausgewählt',
    modelLabel: 'Modell',
    generateAll: 'Alle vergleichen',
    generatingAll: 'Generiere...',
    generating: 'Generiere...',
    waiting: 'Warte...',
    chatPlaceholder: 'Frag Trashy...',
    trashyGreeting: 'Hallo! Ich kann dir helfen zu erkunden, wie verschiedene Sprachen verschiedene Bilder erzeugen. Gib einen Prompt ein und wähle mindestens 2 Sprachen — ich erkläre, was passiert.',
    trashyTranslating: 'Übersetze deinen Prompt in die ausgewählten Sprachen...',
    trashyGenerating: 'Jetzt werden Bilder generiert — gleicher Seed, gleiches Modell, nur die Sprache ändert sich. Schau, was passiert!',
    trashyTranslateError: 'Der Übersetzungsservice ist gerade nicht verfügbar. Der Backend-Server muss möglicherweise neu gestartet werden.',
    trashyError: 'Etwas ist schiefgelaufen. Sieh in der Browser-Konsole nach oder frag die Kursleitung.',
    favorite: 'Zu Favoriten hinzufügen',
    unfavorite: 'Aus Favoriten entfernen',
    forward: 'An Bildtransformation weiterleiten',
    download: 'Bild herunterladen',
    analyze: 'Bild analysieren',
  },
  provenance: {
    title: 'Über dieses Modell',
    madeBy: 'Entwickelt von:',
    learnedFrom: 'Gelernt aus:',
    howBig: 'Wie groß:',
    kidsNote: 'Nicht alle Urheber wurden gefragt, ob die KI von ihrem Werk lernen darf.',
    publisher: 'Herausgeber',
    architecture: 'Architektur',
    parameters: 'Parameter',
    license: 'Lizenz',
    ...
    consent: 'Einwilligung der Urheber',
    consentValues: {
      none: 'Keine',
      partial: 'Teilweise',
      full: 'Vollständig',
    ...
    knownBiases: 'Bekannte Verzerrungen',
    knownGaps: 'Bekannte Lücken',
    youthReflection: 'Jedes Modell hat eine Perspektive, die durch seine Trainingsdaten geprägt ist. Welche Stimmen könnten fehlen?',
  },
  persona: {
    title: 'Persona',
    inputPlaceholder: 'Sag etwas...',
    toggleTTS: 'Sprachausgabe umschalten',
    fallbackGreeting: 'Hallo, ich bin Persona. Ich bin eine Maschine. Kein Assistent. Sprich mit mir.',
    newDialog: 'Neuer Dialog',
    description: 'Persona ist eine KI, mit der du reden kannst. Sie entscheidet, ob sie während des Gesprächs Bilder, Klang, Video oder 3D-Objekte erzeugt. Sie hat Meinungen und kann ablehnen.',
    activate: 'Gespräch starten',
  },
  workshop: {
    title: 'Workshop-Planung',
    memory: {
      label: 'Grafikkartenarbeitsspeicher (VRAM)',
      system: 'System',
      free: 'frei',
      used: '{used} / {total} Gigabyte belegt',
      overBudget: '— passt nicht!',
    },
    models: {
      label: 'Modelle — in den Arbeitsspeicher ziehen oder klicken zum Aktivieren',
      image: 'Bilder',
      video: 'Videos',
      music: 'Musik',
      sound: 'Klänge',
      threeD: '3D',
      needsGb: 'benötigt {gb} Gigabyte',
      loaded: '(geladen)',
      cloudUs: 'Serverbasiert — wird nicht in den VRAM geladen',
      cloudEu: 'Serverbasiert — wird nicht in den VRAM geladen',
    },
    confirm: {
      load: 'Modelle jetzt in den Arbeitsspeicher laden',
      loading: 'Modelle werden geladen...',
      ready: 'Alles geladen — bereit loszulegen!',
      resultLoaded: 'Geladen: {models}',
      resultSkipped: 'Beim ersten Einsatz: {models}',
      resultError: 'Fehler: {details}',
    },
    actions: {
      clearAll: 'Gesamten GPU-Speicher leeren',
      confirmUnload: '{name} entladen? Das bricht alle laufenden Generierungen ab, die dieses Modell verwenden.',
      confirmUnloadComfyui: '{name} entladen wird ALLE ComfyUI-Modelle aus dem Speicher freigeben (ComfyUI unterstützt kein einzelnes Modell-Entladen). Fortfahren?',
      confirmClearAll: 'Dies bricht alle laufenden Prozesse ab und entlädt ALLE Modelle aus dem Arbeitsspeicher. Fortfahren?',
    },
    chat: {
      cloudAdded: '{name} läuft auf Servern von {publisher} in {region}. Es braucht keinen Platz auf der Grafikkarte, aber deine Eingaben werden dorthin gesendet. Jedes Ergebnis kostet Geld aus dem Projektbudget.',
      overBudget: '{name} benötigt {gb} Gigabyte. Das passt nicht in den Arbeitsspeicher! Du musst entweder ein anderes Modell entfernen oder {name} weglassen.',
      freeSpace: '{name} benötigt {gb} Gigabyte. {free} Gigabyte verbleibend.',
      connectionError: 'Verbindungsfehler — bitte versuche es erneut.',
      regionEu: 'Europa',
      regionUs: 'den USA',
      preloadStart: '{count} Modell(e) werden in den Arbeitsspeicher geladen. Das kann einige Minuten dauern — jedes Modell braucht 30 Sekunden bis 2 Minuten.',
      preloadModel: '{name} wird geladen...',
      preloadDone: '{name} geladen.',
      unloading: '{name} wird entladen...',
      unloaded: '{name} entladen.',
      clearingAll: 'Gesamter GPU-Speicher wird geleert...',
      clearedAll: 'Alle Modelle entladen. GPU-Speicher ist frei.',
    },
    greeting: {
      intro: 'Hallo zusammen. Ich bin Trashy, das Hilfssystem dieser Plattform.',
      context: 'Ihr befindet euch auf der Workshop-Planungsseite. Das macht Sinn, denn bevor es losgeht, lohnt es sich, kurz darüber nachzudenken, was ihr eigentlich machen wollt.',
      resources: 'KI-Modelle brauchen überraschend viele Ressourcen. Vor allem brauchen sie Arbeitsspeicher auf der Grafikkarte — der Recheneinheit, die eure Bilder, Videos und Klänge berechnet. Dieser Speicher ist groß, aber nicht unendlich. Und die Modelle, die ihr nutzen wollt, sind so umfangreich, dass er schnell voll wird.',
      planning: 'Wenn jemand ein neues Modell aktiviert, während der Speicher schon voll ist, können lange Wartezeiten entstehen. Allein das Laden eines Modells dauert zwischen 30 Sekunden und 2 Minuten. Einmal geladen, geht dann meist alles sehr schnell.',
      flexibility: 'Ihr könnt natürlich jederzeit andere Modelle laden oder wechseln, ohne auf diese Seite zurückzukehren. Aber dann wartet ihr. Und gute Arbeit, ob künstlerisch oder experimentell, beginnt meist damit, sich vorher zu überlegen, womit man arbeiten will und warum. Wer künstlerisch arbeitet, greift schließlich nicht einfach zum nächsten Gegenstand auf der Straße, nur weil er da liegt.',
      callToAction: 'Schaut euch die Modell-Karten auf dieser Seite an. Ihr könnt sie in die Speicherleiste ziehen und sehen, was zusammenpasst. Oder sagt mir, was ihr in der Sitzung machen wollt, und ich erkläre, welche Modelle dafür geeignet sind.',
    },
