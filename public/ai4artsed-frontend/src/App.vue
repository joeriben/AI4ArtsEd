      ...
      <div class="header-content">
        ...
        <div class="header-center">
          <div class="mode-selector">
            ...
            <router-link to="/canvas" class="mode-button" :class="{ locked: generationLock.isGenerating }" active-class="active" title="Canvas Workflow" @click="guardGenerating($event)">
              <span class="mode-icon">
            ...
            <router-link to="/latent-lab" class="mode-button" :class="{ locked: generationLock.isGenerating, active: $route.path === '/latent-lab' || $route.path === '/surrealizer' || $route.path === '/direct' }" title="Latent Lab" @click="guardGenerating($event)">
              <span class="mode-icon">
                <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24" fill="currentColor">
