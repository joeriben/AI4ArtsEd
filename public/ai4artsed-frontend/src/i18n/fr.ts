export const fr = {
  ...
  compare: {
    activation: {
      ...
      'vlm-analysis': 'Téléversez une image et laissez plusieurs modèles de vision la décrire. Révèle ce que chaque modèle remarque, ce qu\'il ignore et où les descriptions divergent.',
      ...
      'llm-model': 'La même question à trois modèles d\'IA différents. Montre où les données d\'entraînement, les politiques de sécurité et les hypothèses culturelles produisent des réponses différentes.',
    ...
    tabs: {
      ...
      'llm-model': 'Biais de modèle',
      'vlm-analysis': 'Compréhension d\'image',
    ...
    vlmAnalysis: {
      ...
      noModelsInstalled: 'Aucun modèle de vision installé localement.',
